...
SKATTEETATEN_SIDER = [
    # Satser – disse sidene er stabile og fungerer
    ...
    ("satser/merverdiavgift",      "https://www.skatteetaten.no/satser/merverdiavgift/"),
    # Veiledere – kun sider bekreftet å fungere; resten ga 404 i prod

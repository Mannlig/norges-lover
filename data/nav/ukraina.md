<!-- innholds-hash: 875f36888c25a549d7260feb8ecdf6798f4114e04e354e04ba7750f33851eea6 -->
...
- **Sist hentet:** 2026-06-26T23:40:28Z
...
Om rettigheter, økonomisk støtte og annen hjelp du og familien din kan få som flyktninger fra Ukraina
...
Når du får kollektiv beskyttelse, kan du gå direkte i arbeid. Du kan også få tilbud om
...
Dersom du ikke deltar i introduksjonsprogrammet, kan du kontakte

Dersom du ikke klarer å finne jobb på egen hånd, kan Nav hjelpe deg med informasjon, veiledning og ulike tiltak for å øke dine muligheter til å få en jobb. Hvis du ønsker å få hjelp fra Nav, må du
...
- Se
Se video: Registrere cv på nav.no (ukrainsk)
...
- Hvis du finner en jobb i Norge, skal du i utgangspunktet være i stand til å dekke dine boutgifter og livsopphold.
- Hvis du deltar i introduksjonsprogrammet, vil du få introduksjonsstønad fra kommunen. Inntekten fra introduksjonsstønaden skal dekke dine boutgifter og livsopphold.
- Les mer om
- Du kan søke om økonomisk sosialhjelp mens du venter på at introduksjonsprogrammet starter eller dersom inntekten fra introduksjonsstønaden ikke er nok til å dekke dine utgifter.
- Hvis du ikke har rett til å delta i introduksjonsprogrammet og ikke kan forsørge deg selv, kan du søke om økonomisk sosialhjelp.
...
Alle søknader vurderes individuelt. Når du søker, tar vi hensyn til alder, familiesituasjon, hvordan du bor og helse. Hvis du har barn, tar vi særlige hensyn til behovene deres i vurderingen.
...
Når søknaden din er ferdigbehandlet, får du et skriftlig svar, også kalt et vedtaksbrev. I vedtaket ditt kan du lese om hva du har rett på. Hvis du og din veileder har avtalt at du skal være i aktivitet i løpet av vedtaksperioden, står det beskrevet i vedtaket.
...
Hvis du har lav inntekt og høye boutgifter, kan du
...
- Du må ha hatt en årsinntekt på minst et halvt grunnbeløp (G)
- Du bor i Norge. Bor du i Norge er du vanligvis medlem av folketrygden.
Når du søker om foreldrepenger, velger du lengden på foreldrepengeperioden. Ved fødsel av ett barn er foreldrepengeperioden 49 uker med full sats (100%) eller 61 uker og 1 dag med redusert sats (80%).
...
- være mor til barnet (i noen tilfeller kan far eller medmor få engangsstønad)
- ha lovlig opphold, bo og oppholde deg i Norge
- ha vært medlem i folketrygden i minst 12 måneder sammenhengende, direkte forut for tidspunktet for fødselsterminen eller omsorgsovertakelsen
Har du barn under 18 år som bor hos deg i Norge, kan du ha rett på barnetrygd.

Barnetrygden utbetales månedlig. Utbetalingen stanses måneden før barnet fyller 18 år. Barnetrygden skal bidra til å dekke utgifter som følger med det å ha barn.
...
Det betyr at du kan søke om barnetrygd når du får forlenget den midlertidige beskyttelsen, etter å ha hatt opphold i Norge i 12 måneder.
...
- Hvis du har bodd i Norge i minst 5 år etter å ha fylt 16 år, kan du ha rett til alderspensjon. Hvis du har arbeidet i Norge, kan du ha rett til alderspensjon selv om du har bodd i Norge mindre enn 5 år.
- Størrelsen på pensjonen avhenger av din inntekt og botid i Norge. For å kunne ha rett til minste pensjonsnivå, må du ha minst 40 års trygdetid. Trygdetid er den tiden du har bodd i Norge eller vært medlem i folketrygden fordi du har arbeidet i landet.
- I Norge er det vanlig å ta ut pensjon fra fylte 67 år. Dersom du har opptjent alderspensjon som tilsvarer minste pensjonsnivå, kan du ha rett til å ta ut pensjon fra fylte 62 år.
...
- Du må ha bodd eller jobbet i Norge de siste 5 årene før du ble syk eller skadet.
...
- Kollektiv beskyttelse gir ikke rett til supplerende stønad. Hvis du har fått individuell beskyttelse eller en annen oppholdstillatelse som gir grunn for varig opphold, kan du ha rett på supplerende stønad. Dette gjelder både supplerende stønad for uføre flyktninger og personer over 67 år med kort botid i Norge.
- For å ha rett på supplerende stønad for uføre flyktninger må du i tillegg ha søkt og fått vedtak om uføretrygd fra Norge og være under 67 år.
- For å ha rett på supplerende stønad for personer over 67 år med kort botid i Norge må du i tillegg ha søkt og fått vedtak om alderspensjon.
Flyktninger og asylsøkere med funksjonsnedsettelse kan ha rett på å låne hjelpemidler gratis.

- er blind eller ser svært dårlig
- er døv eller hører svært dårlig
- har bevegelsesvansker, for eksempel vansker med å gå eller bruke hendene
- har kognitive vansker, som kan skyldes for eksempel hjerneskade, psykisk sykdom, autisme, demens eller utviklingshemming
- bruker tegnspråk eller alternative kommunikasjonsformer
- rullestol
- toalettstol
- rullator
- høreapparat
...
- briller til barn
- tegnspråktolking
- Hvis du trenger et hjelpemiddel, kan du ta kontakt med kommunen du bor i.
- Du kan også
...
Du kan også bestille Buypass ID, hvis du har fått innvilget kollektiv beskyttelse.

Hvis situasjonen din endrer seg, kan det bli endringer i stønaden du får fra Nav.

- inntekt
- familiesituasjon
- jobbsituasjon
- eller hvis du planlegger opphold i utlandet
Du må også gi beskjed hvis du planlegger et opphold i utlandet.
...
Du har rett til å få veiledning fra Nav for å forebygge eller løse utfordringer med hjemmeforhold, bosituasjon, omsorg for barn, arbeid eller økonomi. For å få for en veiledningssamtale med oss, kan du ta kontakt med Nav-kontoret ditt. Du kan også
...
Hvis du har mulighet til å bytte til norsk kontonummer, anbefaler vi det. Se hvordan du kan

Hvis du er i Norge og ikke får tilgang til bankkontoene dine på grunn av sanksjoner mot Russland, må du kontakte den russiske ambassaden.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/ukraina) av norges-lover-bot.*

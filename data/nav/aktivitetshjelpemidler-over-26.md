<!-- innholds-hash: 3afa487bcae0c50a5064b42cfebf60011983da00c6f002625a8e185ac82014a9 -->
...
- **Sist hentet:** 2026-05-23T20:29:13Z
...
Rammen for 2026 er bundet opp for nye innkjøp. Søker du nå, vil du derfor få avslag.

Det er likevel satt av midler til nødvendig service, reparasjon og deler for aktivitetshjelpemidler som allerede er i bruk. Nav vil fortsatt dekke nødvendige utgifter til dette.

Du kan få aktivitetshjelpemidler hvis du

- har en varig nedsatt funksjonsevne
- trenger hjelpemiddelet for å kunne drive fysisk aktivitet, alene eller sammen med andre
- er over 26 år
- er
Personer som ikke er i stand til å benytte vanlige aktivitetshjelpemidler, kan søke om hjelpemidler som er spesielt utviklet for aktivisering av muskler og skjelett.

Ordningen for aktivitetshjelpemidler for personer over 26 år er rammestyrt. Det vil si at du vil få avslag hvis du søker etter at rammen er oppbrukt. Da må du søke på nytt året etter.

Hvis vilkårene er oppfylt, vil du få innvilget søknaden så lenge det er midler igjen på budsjettet.
...
Hvis du er under 26 år og trenger hjelpemidler for trening, stimulering eller aktivisering, vil du finne informasjon om dette på denne siden:
...
Du kan forhøre deg med kommunal hjelpemiddelformidler eller et helsesportssenter. Du kan også se de konkrete produktene på

Dersom du kan benytte deg av vanlig utstyr som bare trenger en ombygging eller justering, må du selv kjøpe utstyret. Nav hjelpemiddelsentral kan modifisere eller tilpasse produktet ditt.

Nav hjelpemiddelsentral låner ikke ut produkter som er å få i vanlig handel.

Du kan lese mer

Du får låne hjelpemidlene av Nav hjelpemiddelsentral så lenge du trenger det.

Når du ikke lenger har bruk for hjelpemiddelet, skal du levere det  tilbake.

For aktivitetshjelpemidler til personer over 26 år, må du betale en egenandel på ti prosent av kjøpesummen for hjelpemidlet, inntil et egenandelstak:

- Dersom du låner et nytt hjelpemiddel, er egenandelen maksimalt 7000 kroner per hjelpemiddel.
- Dersom du får låne et brukt hjelpemiddel, er taket for egenandelen på 2000 kroner.
Det er ingen egenandel ved spesialtilpasning av ordinært utstyr.

Det er heller ingen egenandel ved reparasjon av utlånt aktivitetshjelpemiddel.

Hjelpemiddelet vil ikke bli utlevert før du har betalt egenandelen.

Egenandelen gjelder for det konkrete hjelpemiddelet du har fått vedtak på, og vil ikke bli refundert hvis du leverer tilbake eller bytter hjelpemiddelet.
...
Hvis du har fått avslag på søknad om aktivitetshjelpemidler fordi rammen er brukt opp, kan du ikke klage.

Du kan klage hvis avslaget er begrunnet med at vilkårene ikke er oppfylt.
...
Les bruksanvisningen som følger med produktet. Noen hjelpemidler har behov for jevnlig lading. Dette må du passe på selv.
...
Du kan ikke bytte et hjelpemiddel du har fått som aktivitetshjelpemiddel for personer over 26 år. Hvis du har behov for nytt hjelpemiddel, må du søke på nytt.
...
Egenandelen blir ikke refundert når du leverer tilbake hjelpemiddelet.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/aktivitetshjelpemidler-over-26) av norges-lover-bot.*

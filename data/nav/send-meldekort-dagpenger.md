<!-- innholds-hash: f34954ebf6163775c448d09edd8115d453579f7c4766435aae6190fabaa3b2fd -->
...
- **Sist hentet:** 2026-07-04T11:49:26Z
...
Fra du har registrert deg som arbeidssøker, og mens du venter på svar på søknaden, må du sende meldekort hver 14. dag gjennom hele perioden du mottar dagpenger.
...
Meldekortet er et skjema du må fylle ut og sende hver 14. dag mens du mottar dagpenger. Det brukes for at Nav skal kunne beregne hvor mye du skal få i dagpenger. Du må fylle ut om du har jobbet, hatt fravær, eller deltatt i aktiviteter.
...
På meldekortet gir du også beskjed om du fortsatt ønsker å være registrert som arbeidssøker hos Nav. Svarer du
...
Du blir trukket for antall dager fra første mandag etter at meldeperioden er over, til dagen du sendte inn meldekortet. Sender du meldekortet én dag etter siste frist, får du derfor trekk for 6 ukedager.


#### Pass på at du ikke mister dagpengene dine

Har det gått mer enn 20 dager siden siste gang du sendte et meldekort, blir du tatt ut av arbeidssøkerregisteret hos Nav. Når du er ute av arbeidssøkerregisteret stopper vi pengestøtten din, og du vil ikke lenger motta hjelp eller oppfølging.
...
Du har ikke rett til dagpenger når du er syk, men du kan ha rett til sykepenger. Når du mottar dagpenger må du be om sykmelding fra første dag du er syk.

Du kan som hovedregel oppholde deg hvor du vil i Norge når du mottar dagpenger, uten å føre fravær på meldekortet.

Hvis du ikke er tilgjengelig for jobb eller tiltak på grunn av ferie eller annet fravær, må du føre disse dagene som fravær på meldekortet. Les mer om

Hvis du har fravær, vil du ikke få utbetalt dagpenger de dagene du har fravær.

Reiser til utlandet skal også føres som ferie, fravær eller utenlandsopphold på meldekortet. Les mer om

Hvis du fortsatt vil motta dagpenger må du svare
...
Hvis du er usikker på hvor mange timer du skal føre på meldekortet, kan du ta
...
På meldekortet skal du føre 7,5 timer fra mandag til fredag i arbeidsperioden om bord, og det samme i avspaseringsperioden.
...
Hvis du er fosterforelder i et forsterket fosterhjem, må du

Hvis du er drosjesjåfør skal du føre opp hele vakten din på meldekortet.

Hvis du er drosjesjåfør med unntak fra å være tilknyttet en drosjesentral, og har drosjen parkert ved boligen din, skal 1/7 av den tiden bilen er disponibel føres opp på meldekortet
...
Hvis du får dagpenger og skal delta på heimevernsøvelse, så skal du svare

Hvis du er tatt ut i streik fra din deltidsstilling, skal du fylle ut meldekortet som om du var på jobb som vanlig. Dette gjør du uavhengig av om du får streikebidrag fra fagorganisasjonen din eller ikke.

Er du tilkallingsvikar, skal du føre avtalte timer med arbeid på meldekortet.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/send-meldekort-dagpenger) av norges-lover-bot.*

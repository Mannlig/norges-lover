<!-- innholds-hash: e5cc9e66716088e92b1442c6602e0221ca570d137ffb2efd75142e9705ff1425 -->
...
- **Sist hentet:** 2026-05-14T01:57:44Z
...
Det finnes også informasjon om uføretrygd til
...
#### Lovendringer uføretrygd 2026

Det kommer flere lovendringer i regelverket for uføretrygd i 2026. Du får varsel- og vedtaksbrev fra oss hvis endringene påvirker din uføretrygd.

For å ha rett til å få uføretrygd, må varig sykdom og/eller skade være hovedårsaken til at du har nedsatt inntektsevne.
...
- Du må som hovedregel ha minst 50 prosent redusert inntektsevne.

#### Det kan være andre regler hvis:
...
- uførheten din skyldes en godkjent yrkesskade eller yrkessykdom
Eller hvis du har vært medlem av folketrygden i minst ett år umiddelbart før du søker om uføretrygd, og

- ble ufør før du fylte 26 år og da var medlem av trygden eller
- etter fylte 16 år har vært medlem i trygden med unntak av maksimum fem år
Eller hvis du var medlem av folketrygden på uføretidspunktet, og

- har tjent opp rett til minst halvparten av minsteytelsen for uføretrygd
Hvis du har jobbet i et annet land og tjent opp trygdetid der, kan denne tiden noen ganger regnes med som om det var trygdetid i folketrygden.

Trygdetid i avtaleland kan legges sammen med trygdetid i Norge for å fylle vilkår om medlemskap. Dette gjelder bare hvis Norge har en avtale med det aktuelle landet. Norge har slike avtaler med blant annet EU/EØS-landene.

Før du kan søke om uføretrygd, må vi som hovedregel avklare mulighetene dine til å være i arbeid.

Det betyr at du må være ferdig med

- nødvendig behandling som kan bedre inntektsevnen din
- nødvendige tiltak for å bedre inntektsevnen din og avklare hvor mye du kan jobbe
Inntektsevnen din avklares sammen med en veileder ved ditt lokale Nav-kontor. Når veilederen din vurderer at du er ferdig avklart, kan du søke om uføretrygd.
...
#### Har AFP og ønsker å søke om uføretrygd
...
Det er samme skatt for uføretrygd som for vanlig lønnsinntekt.
...
- feriepenger (opptjent etter innvilget uføretrygd)
- bonus, ekstratimer, overtidsbetaling
- skattepliktige fordeler fra arbeidsgiver (for eksempel kost og losji, lån fra arbeidsgiver, telefon)
...
- omstillingsstønad
- fosterhjemsgodtgjørelse (delen som utgjør arbeidsgodtgjørelse)
Kontakt Skatteetaten hvis du har andre spørsmål om pensjonsgivende inntekt.


#### Dette kan også påvirke beregning av uføretrygd

Hvis du har inntekt ved siden av uføretrygden, får du gradert uføretrygd. Når vi fastsetter uføregraden din, bruker vi inntekten du hadde før du ble ufør og ser denne opp mot inntekten du eventuelt skal ha ved siden av uføretrygden.
...
- Du var under 26 år da du ble alvorlig og varig syk eller skadet.
...
- du har minstesats
- du har rettigheter som ung ufør
- du har barnetillegg
Derfor er det viktig å gi oss beskjed hvis du endrer sivilstand.

Har du fått uføretrygd på grunn av en godkjent yrkesskade eller yrkessykdom? Da blir uføretrygden
...
- har permisjon eller botrening, slik at du oppholder deg halve tiden eller mer utenfor institusjonen. Da kan du søke Nav om å få beholde hele uføretrygden.
...
Hvilken minstesats du får avhenger av
...
Du kan også ha rett til barnetillegg for fosterbarn du forsørger. Forutsetningen er at du har varig ansvar for å forsørge barnet, og at barnet er plassert i fosterhjem i forbindelse med omsorgsovertakelse.
...
Trygdetiden din har betydning for barnetillegget. Har du ikke full trygdetid, vil barnetillegget bli redusert ut fra
...
Barnetillegget blir utbetalt sammen med uføretrygden, se kapitlet


#### Etteroppgjør

Når skatteoppgjøret er klart, gjør Nav et etteroppgjør. Har du fått utbetalt for lite barnetillegg, vil du få etterbetalt. Hvis du har fått utbetalt for mye barnetillegg, må du betale dette tilbake. Se

Se video: Uføretrygd og barnetillegg
...
Får du gradert uføretrygd, kan du ha rett til
...
Har du en uføregrad på 50 prosent eller mer, har du


#### Har du mistet honnørkortet ditt?

Du bestiller nytt honnørkort ved å

Får du uføretrygd, kan hele eller deler av studielånet ditt slettes. Du kan lese mer om dette på

Har du lav inntekt og høye boutgifter, kan du ha rett til bostøtte. Du kan lese mer om dette på

Du kan ha rett til uførepensjon eller uføreforsikring fra andre enn Nav (for eksempel KLP, SPK, OPF eller forsikringsselskap).

Uførepensjon krever som regel at du har eller har hatt medlemskap. Uføreforsikring må du enten ha privat, eller via arbeidsplassen eller fagforeningen din.
...
Hvis du har fått lønnsøkning som arbeidstaker (ansatt), kan du søke om å få økt inntektsgrensen din. En høyere inntektsgrense betyr at du kan tjene mer før uføretrygden reduseres.
...
På Din uføretrygd finner informasjon om utbetalingene dine, du kan melde fra om endringer, lese brev, og finne dokumenter.
...
Kan du ikke logge inn, kan du ringe oss på 55 55 33 33.
...
- du har norsk eller utenlandsk inntekt i tillegg til uføretrygden din
- inntekten din endrer seg
- du har barnetillegg for felles barn og samboer/ektefelle har inntekt eller får endring i inntekt

#### Alle andre endringer må du melde fra om her

- endrer adresse. Du må også
- endrer sivilstatus. Du må også
- du har fått for mye eller for lite utbetalt uføretrygd
- det skjer endringer i omsorgsituasjonen for barna du forsørger
- tjenestepensjon fra offentlig eller private ordninger endrer seg
- individuelle pensjonsordninger, livrente og gavepensjon endrer seg
- ytelser og pensjon fra andre land endrer seg
- du, samboer eller ektefelle blir innlagt på institusjon
- du, samboer eller ektefelle sitter i varetekt, soner straff eller er under forvaring.
...
Du har også et årlig inntektstak som viser hvor mye du kan tjene før du ikke lenger får utbetalt uføretrygd. Du beholder retten til uføretrygd, selv om du ikke får utbetaling.

Får du lavere inntekt i fremtiden, vil utbetalingen av uføretrygden øke.


#### Disse inntektene påvirker utbetaling av uføretrygd, barnetillegg og gjenlevendetillegg
...
Personinntekt er all pensjonsgivende inntekt, i tillegg til

- uføretrygd
- pensjoner fra Nav og utlandet
- uførepensjon og pensjoner fra andre (for eksempel fra KLP, OPF, SPK, Gjensidige, Storebrand)

#### Bruk inntektsplanleggeren til å melde fra om inntekt

Hvis du jobber eller planlegger å jobbe, bør du gi beskjed om endringer i inntekten din så tidlig som mulig. Dette kan du gjøre i inntektsplanleggeren som du finner lenke til litt lenger ned på siden, eller ved å logge inn på Din uføretrygd. Her kan du melde fra om hvor mye du forventer å tjene, og se hvordan det vil påvirke din utbetaling.

Du kan bruke inntektsplanleggeren som en kalkulator for å få se hvordan inntekten din påvirker utbetalingen av uføretrygd. Du kan også bruke inntektsplanleggeren til å melde fra til oss om forventet inntekt, hvis du trykker "send inn" på beregningene du har gjort.

Det kan være vanskelig å vite både hva du forventer å tjene dette året, og hvor mye du kommer til å tjene neste år.

Derfor er det viktig at du melder i fra til oss om endring i inntekten din så snart du ser at den blir annerledes enn det du tidligere har meldt inn. Du kan sende oss endringer i inntekt gjennom inntektsplanleggeren så ofte du trenger.

Dette gir mindre risiko for at du må betale tilbake en stor sum når etteroppgjøret kommer.

Se video: Slik bruker du inntektsplanleggeren

Varighet er 3,5 min


#### Slik påvirker inntekt uføretrygden din
...
- Kim har 50 prosent uføretrygd, og jobber 50 prosent ved siden av uføretrygden.
- I full stilling, ville Kim tjent 400 000 i året. Kim jobber i en 50 prosent stilling og tjener 200 000.
- Inntektsgrensen for Kim er 200 000 + 52 064 (0,4 G) = 252 064
- Kim kan ha 252 064 i inntekt, uten å få lavere utbetaling av uføretrygd.
Hvis du har gradert uføretrygd og har fått varig lønnsøkning som arbeidstaker (ansatt), kan du søke om å få endret inntektsgrensen din. Det betyr at du kan tjene mer før du får lavere utbetaling av uføretrygd.

Du kan bare få endret inntektsgrensen din hvis

- inntektsøkningen ikke skyldes økt stillingsprosent eller overtidsarbeid
- inntektsøkningen er høyere enn reguleringen av
...
#### Inntektstak - Når du tjener for mye for å få utbetalt uføretrygd

Tjener du mer enn inntektstaket ditt per kalenderår, har du ikke rett til å få utbetalt uføretrygd dette året. Inntektstaket ditt er 80 prosent av inntekten du hadde før du ble ufør, oppjustert til dagens verdi. Har du tjent mer enn inntektstaket ditt i løpet av et kalenderår og fått utbetalt uføretrygd det samme året, må du betale tilbake uføretrygden.

Du beholder retten til uføretrygd selv om du ikke får den utbetalt, og du kan igjen få utbetaling av uføretrygd hvis inntekten din endrer seg i fremtiden.

Eksempel:

- Kim hadde en inntekt før uførhet på 400 000 kroner, 80 prosent av 400 000 = 320 000. Inntektstaket til Kim er derfor 320 000 kroner.
- Hvis Kim har høyere inntekt enn 320 000, mister Kim utbetalingen av uføretrygd det aktuelle året.
- Har Kim fått utbetalt uføretrygd dette året, må Kim betalte det tilbake.

#### Hvilende rett

Når du har så høy inntekt at du ikke får utbetalt uføretrygd, kalles det å ha hvilende rett. Du kan ha hvilende rett i inntil 5 år, med mulighet for forlengelse i 5 år til. Etter 10 år med sammenhengende hvilende rett, opphører vi uføretrygden din. Du vil få både varsel- og vedtaksbrev før vi gjør endringer i uføretrygden din.

Hver høst sjekker vi inntektsopplysningene i skatteoppgjøret ditt for å se om du har fått utbetalt riktig beløp i uføretrygd året før.

Viser skatteoppgjøret at du har hatt en annen inntekt enn den vi brukte da vi beregnet uføretrygden din, gjør vi en ny beregning for det aktuelle året. Dette kalles etteroppgjør.

Etteroppgjøret har mange likheter med skatteoppgjøret:

- Har du fått utbetalt for lite, får du en etterbetaling fra oss.
- Har du fått utbetalt for mye, må du betale tilbake.
- Har du fått utbetalt riktig beløp av uføretrygd, får du ikke etteroppgjør.
Etteroppgjøret gjelder uføretrygd, barnetillegg og gjenlevendetillegg.

Se video: Etteroppgjøret på 1-2-3

Varighet er 3 min


#### Når får du etteroppgjøret?

Vi jobber med etteroppgjøret over en lenger periode fra oktober. Derfor får ikke alle etteroppgjøret samtidig.

Har du fått utbetalt feil beløp i uføretrygd i fjor, får du beskjed på SMS og e-post om å logge inn på nav.no. Her finner du opplysninger om etteroppgjøret ditt. Har du fått riktig utbetaling i fjor vil du ikke få noen beskjed fra oss.

Har du fått for lite utbetalt, får du etterbetaling fra oss. Vi betaler ut hele beløpet innen 7 virkedager fra datoen i vedtaksbrevet. Du får ikke renter på etterbetalingen.

Informasjon om

Har du gjeld som Skatteetaten krever inn, kan

Har du fått for mye utbetalt, må du betale tilbake. Du vil få et brev fra oss med informasjon om dette.

Etter 4 uker får du en giro fra Skatteetaten med informasjon om hvordan du kan betale tilbake.
...
- Har du ikke takket ja til eFaktura i nettbanken din, får du brevet med betalingsinformasjon i Altinn.
- Kan du ikke få digital post, får du brevet i posten.
Du kan ikke betale tilbake før du har fått dette brevet. Skatteetaten kan ikke svare deg på spørsmål om saken din før du har fått brevet fra dem.
...
#### 2) Trekk i støtte fra Nav

Du kan la være å betale hele eller deler av beløpet, altså se bort fra giroen. Hvis du fortsatt får uføretrygd eller annen pengestøtte fra Nav, kan Skatteetaten automatisk trekke det du skylder fra denne støtten. Normalt trekker Skatteetaten 10 prosent av innvilget uføretrygd frem til hele beløpet er betalt tilbake. Har du allerede trekk fra forrige etteroppgjør, kan du nå få to trekk på 10 prosent.


#### 3) Trekke mer eller mindre enn 10 prosent

Vil du betale ned raskere, kan du be Skatteetaten om å trekke mer enn 10 prosent.

Du vil få et varselsbrev om tilbakekreving. Du har en frist på 3 uker fra du får varselet til å komme med tilbakemeldinger eller nye opplysninger. Hører vi ikke fra deg, blir varselet automatisk omgjort til et vedtak etter 4 uker.


#### Inntekter som er med når vi beregner etteroppgjøret

Vi bruker din pensjonsgivende inntekt når vi beregner uføretrygd og gjenlevendetillegg. Barnetillegget for særkullsbarn blir beregnet ut fra din personinntekt. For barnetillegg for fellesbarn, bruker vi i tillegg den andre forelderens personinntekt.
...
Noen inntekter skal ikke påvirke utbetalingen av uføretrygd og kan derfor holdes utenfor etteroppgjøret.

Inntekter du har fått utbetalt etter du ble ufør, men som er knyttet til aktiviteter som ble avsluttet før du ble ufør, kaller vi for etterslepsinntekter. Noen etterslepsinntekter skal ikke føre til at utbetalingen av uføretrygden blir lavere. Derfor skal de holdes utenfor etteroppgjøret.

Eksempler på etterslepsinntekter er

- feriepenger som er opptjent fra lønn og sykepenger før du fikk innvilget/endret grad uføretrygd.
...
- etterbetalinger og pengestøtte fra Nav, hvis pengestøtten er pensjonsgivende og etterbetalingen har skjedd i 2024 eller senere.
Hvis du har fått feriepenger du mener kan holdes utenfor etteroppgjøret, må du

Hvis du har mottatt andre etterslepsinntekter i året etteroppgjøret gjelder for, må dette dokumenteres.

Når vi har fått dokumentasjon fra deg, vurderer vi om inntekten skal holdes utenfor. Du får beskjed fra oss hvis endringen påvirker etteroppgjøret ditt.

Erstatningsoppgjør kan holdes utenfor etteroppgjøret hvis du har fått utbetalt erstatning for inntektstap ved:

- Skade (Skadeerstatningsloven § 3-1,)
- Yrkesskade (Yrkesskadeforsikringsloven § 13)
- Pasientskade (Pasientskadeloven § 4 første ledd)
...
I etteroppgjøret vil vi alltid vurdere om unntaket for arbeidsforsøk kan brukes for deg som har tjent mer enn 80 prosent av inntekten du hadde før du ble ufør.

Har du hatt et arbeidsforsøk, trenger du ikke kontakte oss om dette. Du vil i så fall få et eget brev med informasjon om dette som en del av etteroppgjøret.


#### Feil opplysninger om inntekt i etteroppgjøret

Hvis du mener at inntektsopplysningene i skatteoppgjøret er feil, må du kontakte Skatteetaten.

Når Skatteetaten har gjort endring av inntekten, må du

Hvis du mener inntektsopplysninger for den andre forelderen er feil, må den andre forelderen kontakte Skatteetaten.

Når Skatteetaten har gjort endring av inntekten, må du

Hvis inntekten din fra uførepensjon og pensjoner fra andre (for eksempel fra KLP, OPF, SPK, Gjensidige, Storebrand) blir endret, må du gi beskjed til oss når endringen er gjort. Da må du

Du opparbeider deg rett til alderspensjon når du får uføretrygd. Jobber du ved siden av uføretrygden, kan du få en høyere alderspensjon.

Du bør undersøke hva som gjelder i overgangen til alderspensjon og eventuelt avtalefestet pensjon (AFP).
...
Før du flytter, kan Nav vurdere om du har rett til å ta med deg hele eller deler av uføretrygden din til utlandet.
...
Du må også melde fra til Nav om endringer når du flytter til utlandet. Les mer under kapitlet
...
Har du uføretrygd etter særregler for flyktninger, kan du beholde uføretrygden hvis du flytter til et EU/EØS-land. Særreglene gjelder bare flyktninger som søkte om uføretrygd før 01.01.21. Flytter du til et annet land som Norge har trygdeavtale med, kan uføretrygden bli redusert, eller stanse helt.

Har du uføretrygd etter
...
Medlemskap i folketrygden er nøkkelen til rettigheter fra Nav. Det er

Reiser du fra Norge med planer om å oppholde deg mindre enn 12 måneder i utlandet, beholder du
...
Hvis du under perioden med midlertidig fravær fra landet begynner å jobbe i utlandet eller på et utenlandsregistrert skip, opphører medlemskapet i folketrygden straks. Du kan lese mer om

Hvis du får barnetillegg, er det egne regler for hvor lenge du kan beholde dette tillegget når du oppholder deg i utlandet. Se mer om
...
Hvis du ønsker å beholde medlemskap i folketrygden utenfor EØS-området, kan du søke om frivillig medlemskap i folketrygden. Les mer om

Hvis du skal bosette deg innenfor EØS-området eller Sveits, har du rettigheter i bostedslandet ditt og er ikke medlem i folketrygden. Du kan i visse tilfeller få innvilget frivillig medlemskap i folketrygden. Les mer om

Det er forskjellige regler innenfor og utenfor EØS-området. Les
...
Hvis du skal oppholde deg i utlandet og får annen pengestøtte fra Nav, må du undersøke om du kan

I enkelte saker der personer har gått fra arbeidsavklaringspenger til uføretrygd er det gjort feil i fastsettelsen av tidspunktet for når utbetalingene av uføretrygd startet. Feilen i virkningstidspunkt gjelder saker fra perioden 2010 til 2021. Dette kan ha ført til feil i utbetalinger av uføretrygd.

- Nav vil ikke kreve tilbake penger fra de som har fått utbetalt for mye.
I cirka 80.000 saker har utbetaling vært for liten i én enkeltmåned. De fleste av disse sakene gjelder beløp på 3000-4000 kroner.

Nav jobber nå med å rette opp rundt 1800 saker der det har vært løpende feil med for lave utbetalinger siden 2015. Vi tar direkte kontakt med de som er berørt av en slik sak.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/uforetrygd) av norges-lover-bot.*

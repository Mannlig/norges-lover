...
Read more about the difference between the state's and the local authorities' responsibilities here:
...
We use personal data when distributing tasks between our employees, following up applications, and ensuring correct payments are made. Sometimes there is a robot that distributes the tasks. We also need personal data to provide you with good user support and to correct errors in our IT systems.
...
We use personal data to develop and improve systems and processes to provide faster case processing services of higher quality. This includes user insights such as user interviews, surveys, and user tests. This user insight will usually be based on consent, where information about the processing and your rights will be stated in the consent declaration.
...
- The Labour and Welfare Administration Act (
- The National Insurance Act (
- The Labour Market Act (
- The Child Benefit Act (
- The Advance Payments of Child Support Act (
- The Pension for Fishermen Act (
- The Wage Guarantee Scheme Act (
- The Cash Benefit Act (
- Act on supplementary benefit for persons who have only lived a short period in Norway (
- Act on state subsidies to employees who receive contractual pension in the private sector (AFP Subsidies Act) (
- Act on contractual pension for the members of the Norwegian Public Service Pension Fund (
- Act on suspension of payments following child abduction (
- Act (No. 21 of 1946) on war pension for military people (
- Act (No. 22 of 1946) on war pension for home force personnel and civilians (
...
- developing systems that use artificial intelligence
...
You cannot object to automated evaluations of applications, but if you disagree with the decision, you have the right to appeal it. Read more about your
...
We may use personal data to develop artificial intelligence. By using artificial intelligence to develop our services, you as a user can expect to receive services that are better tailored to your needs.

We do not use artificial intelligence to make automated decisions or issue automated administrative decisions.
...
If you are a party to a case, for example, a child maintenance case, you have the right to access the case documents. In cases where you are not a party, you will have the right to access
...
If you have questions regarding your rights or have more questions concerning privacy, please
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/personvernerklaering/en) av norges-lover-bot.*

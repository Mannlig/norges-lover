...
## Pengestøtter og tjenester

Fra A til Å

Oversikt over alle Navs pengestøtter og tjenester til privatpersoner. Bruk søket eller velg område for å finne frem i listen.

Ser du etter et spesifikt skjema? Se oversikt over alle
...
Gir råd og veiledning når du har trenger tilrettelegging på arbeidsplassen.
...
Nav vurderer å stanse utbetalinger ved barnebortføring. Finn ut hvordan vi behandler slike saker, hvilke rettigheter foreldre har, og hvor du kan få hjelp.
...
Hvis du tidligere har bodd eller jobbet i et annet land enn Norge, kan du har rett til pensjon fra det landet. Se hvordan du søker om pensjon fra andre land.
...
Logg inn på Din pensjon for å sjå kva du kan få i pensjon frå folketrygda.
...
Støtte til folkehøyskole dekker ekstrautgifter for elever på tilrettelagte linjer med opplæring i daglige aktiviteter. Tilpasningskurs gir verktøy og kunnskap for personer med nedsatt syn eller hørsel.
...
Hjelper deg når du har en funksjonsnedsettelse.
...
Hjelpemidler som kan gjøre hverdagen enklere for personer med nedsatt hørsel, eller redusere tinnitus (øresus) i stille omgivelser eller ved sengetid.

Aktivitetshjelpemidler til idrett og mosjon for barn og ungdom under 26 år
...
Dersom du har behov for langvarige og koordinerte tjenester eller er deltaker i kvalifiseringsprogrammet, har du rett til å få utarbeidet en individuell plan.

Et tilskudd til arbeidsgiveren din når du trenger tilrettelegging på arbeids- eller tiltaksplassen.

Offentleglova regulerer allmennhetens rett til innsyn hos det offentlige. Disse reglene om innsyn gir deg informasjon om hva Nav arbeider med på alle områder, og om Navs avgjørelser.  Du har ikke rett til å se opplysninger som er taushetsbelagte.
...
Hvis du allerede har uføretrygd, kan du logge inn og bruke inntektsplanleggeren for å melde fra om inntektsendringer og se hvordan inntekt påvirker utbetalingen av uføretrygden din.

Pengestøtte som kommunen utbetaler når du deltar i introduksjonsprogrammet.
...
For å være registrert som arbeidssøker hos Nav, må du sende en bekreftelse på dette hver 14. dag.
...
Hvis du mottar kommunal omsorgsstønad (tidligere omsorgslønn), må du melde fra til Nav hvis du søker om/har en pengestøtte fra Nav.
...
Hjelpemidler som ortose, protese, ortopediske sko, parykk, øyeprotese eller ansiktsprotese.
...
Kan gi råd og veiledning om Navs behandling av personopplysninger og hjelpe deg med å ivareta dine personverninteresser.
...
Beregn din fremtidig alderspensjon, AFP og tjenestepensjon fra noen leverandører og legg til individuelle spareavtaler.
...
Rekrutteringsprogrammet har som mål å bidra til at flere personer kommer i jobb i helse- og omsorgssektoren i kommunene.
...
Ungdomsgarantien gjelder for deg som er i alderen 16 til 30 år og som trenger hjelp fra Nav til å komme i arbeid eller fullføre utdanning.
...
Har du blitt kalt inn til et videomøte med Nav? Se hvordan du forbereder deg til møtet på mobil eller PC.
...
Alle som har fått utbetalinger fra Nav får årsoppgave på starten av året.


---
*Automatisk hentet fra [NAV](https://www.nav.no/tjenester) av norges-lover-bot.*

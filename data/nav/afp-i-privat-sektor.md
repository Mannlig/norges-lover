<!-- innholds-hash: ebc8a09469c0fe9e0a88f75eb1b6cb741e4654fdae7ca0732fc80125faf0b4da -->
...
- **Sist hentet:** 2026-07-20T10:04:38Z
...
I noen tilfeller kan du kombinere AFP i privat sektor med gjenlevendepensjon eller

Jobb og opphold i utlandet kan få betydning for retten til AFP. Kontakt
...
Hvis du har mistet jobben, må du
...
AFP i privat sektor legges til alderspensjonen når det vurderes om du har nok opptjening til å ta ut alderspensjon før du fyller 67 år.
...
Du som er født i årene 1944-1962 har hele eller deler av alderspensjonen din beregnet etter
...
#### Opplysninger om ektefelle, partner eller samboer

- Navn
- Fødselsnummer eller D-nummer
- Statsborgerskap
- Forventet årlig inntekt før skatt
Det er ikke nødvendig å oppgi inntekt fra alderspensjon fra folketrygden og uføretrygd.

Med inntekt mener vi:

- arbeidsinntekt
- kapitalinntekt, for eksempel bankinnskudd
...
#### Ekstra opplysninger for samboere

Hvis du har samboer, må vi vite når dere flyttet sammen, om dere har vært gift med hverandre før, og om dere har felles barn.
...
Hvis du har lav eller ingen opptjening til alderspensjon, kan du ha rett til pensjon etter satsene for minste pensjonsnivå eller garantipensjon. Din sivilstand og inntekten til ektefelle, partner eller samboer har da betydning for hvilken sats du skal ha.


#### Opplysninger om jobb og opphold i andre land

Hvis du bor i Norge nå, men har bodd eller jobbet i andre land etter at du fylte 16 år, ber vi deg oppgi

- hvilke(t) land
- hvilke tidsperioder
- ditt utenlandske identitetsnummer
- din utenlandske pensjonsordning
Ferieopphold skal ikke registreres.


#### Opplysninger om arbeidsgiver

Hvis du søker om AFP i privat sektor, må du gi oss opplysninger om din nåværende arbeidsgiver. Noen virksomheter består av flere organisasjoner, så du må passe på at du oppgir rett organisasjonsnummer og adresse.
...
Hvis du ikke ennå har fått AFP i privat sektor, kan opphold i utlandet få betydning for retten til AFP. Kontakt
...
Hva lønner seg for deg? Du må velge mellom
...
Du kan kontakte oss på telefon 55 55 33 34 for å få hjelp til å vurdere hvilket valg som passer for deg. Du kan også

Hvis du har søkt om uføretrygd fra Nav og ønsker å si fra deg AFP i privat sektor, må du gi Nav beskjed i god tid. Du må også gi beskjed hvis du velger å beholde AFP. Du kan
...
Hvis du flytter til et annet nordisk land, får du helserettigheter etter reglene i det landet du bosetter deg i. Hos

AFP-pensjonister i utlandet kan søke om
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/afp-i-privat-sektor) av norges-lover-bot.*

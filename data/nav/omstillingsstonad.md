<!-- innholds-hash: 67bc051b339113bea12d4615cde40601100f64662d9e5700978b46011ee9fff4 -->
...
- **Sist hentet:** 2026-07-04T12:59:13Z
...
Du kan ha rett til omstillingsstønad frem til du fyller 67 år. Har du fylt 67 år, kan du ha
...
- Blir felles barn født etter dødsfallet får du ikke omstillingsstønad. Du kan ha rett til
...
Når et dødsfall skyldes en godkjent yrkesskade eller yrkessykdom, kan du har rett til omstillingsstønad etter egne regler. For eksempel er kravene til medlemskap i folketrygden mindre omfattende, og krav til ekteskapets varighet eller felles barn gjelder ikke. Du må søke om å få godkjent at
...
Hvis du er født før 1963, kan du ha rett til
...
Full omstillingsstønad er 2,25 ganger
...
Stønaden kan bli lavere hvis avdøde har bodd i utlandet. Det er avdødes trygdetid som legges til grunn når vi beregner omstillingsstønad. For å få full omstillingsstønad må den avdødes trygdetid være beregnet til minst 40 år. Vi tar ikke med trygdetid over 40 år i beregningen.
...
Stønaden kan forlenges med inntil 2 år hvis du
...
Barn som har mistet en eller begge foreldrene, kan få
...
Hvis avdøde har hatt opptjening i et land Norge har
...
Barnepensjon er trekkpliktig fra 1. januar 2025. Det betyr at vi trekker skatt av alle utbetalinger av barnepensjon fra og med 1. januar 2025. Skattetrekket på barnepensjon er fastsatt til 17 prosent.
...
Når den avdøde har bodd eller arbeidet i Norge, og du som etterlatt bor i et land Norge ikke har trygdeavtale med, skal du søke direkte til Nav. Du finner
...
Omstillingsstønaden reguleres i takt med grunnbeløpet fra 1. mai hvert år. Du ser den nye satsen på utbetalingen for juni. Sammen med utbetalingen i juni får du også etterbetalt økning av pensjon for mai måned, så fremt du hadde stønad i mai.

Selv om omstillingsstønaden din øker når grunnbeløpet justeres, blir den fortsatt redusert ut fra inntekten du tidligere har meldt til oss. Hvis inntekten din endrer seg i løpet av året, må du gi beskjed til oss."
...
Skattekortet overføres automatisk fra Skatteetaten til Nav. Hvis du ønsker å endre skattekortet ditt, gjør du dette på

Her kan du sjekke eller
...
Av dette beløpet blir det trukket 45 prosent: 437 986 kroner x 45 prosent = 197 093 kroner

Det vil si at omstillingsstønaden blir redusert med 197 093 kroner per år. Det tilsvarer 16 424 kroner per måned.

Full omstillingsstønad er 2,25 x grunnbeløpet som blir 279 063 kroner per år. Det tilsvarer 23 255 kroner per måned.

Månedlig omstillingsstønad
...
Av dette beløpet blir det trukket 45 prosent: 237 986 kroner x 45 prosent = 107 093 kroner

Det vil si at omstillingsstønaden blir redusert med 107 093 kroner per år. Det tilsvarer 8 924 kroner per måned.
...
- Endrer inntekten din seg mens du får omstillingsstønad, må du gi oss beskjed så snart som mulig. Når vi får riktig informasjon om din inntekt, blir sjansen mindre for at du får utbetalt for mye omstillinsgsstønad og må betale tilbake igjen.

#### Meld fra om inntekt

Skal du melde fra om endringer i inntekt, må du gi oss beskjed ved å melde inn endring.

Kan du ikke melde fra om inntekt digitalt, må du gi oss beskjed med posten.

Bor du i Norge kan du

Bor du i utlandet kan du sende dokumentasjon og endringer til
...
Du kan se hva arbeidsgiverne dine har meldt inn til offentlige registre. Du finner dette i Aa-registeret på
...
12 måneder etter dødsfallet, skal vi vurdere hvor mye aktivitet det er hensiktsmessig å kreve av deg utover 50 prosent.

Omstillingsstønaden stanser etter 3 år. Derfor vil vår vurdering ta hensyn til om du kan forsørge deg selv med egen inntekt når du ikke lenger får omstillingsstønad fra oss.

Vi vil også legge vekt på din helse, alder, evner, utdanning og yrkesbakgrunn. Har du barn, skal vi også vurdere barnets beste der det er relevant. Vi skal også vurdere arbeidsmuligheter på steder der det er rimelig at du tar arbeid.
...
For å ha rett til omstillingsstønad som arbeidssøker må du være arbeidsfør og villig til å ta alle slags jobber, hvor som helst i Norge. Hvis du ikke tar imot tilbud om jobb, arbeidsmarkedstiltak eller ikke møter til innkalling, kan vi stanse utbetalingen av omstillingsstønad til du igjen oppfyller aktivitetsplikten.
...
Det er viktig at du melder fra om endringer som kan påvirke omstillingsstønaden din. Gi beskjed til Nav om endringen, slik at du ikke får for mye eller for lite utbetalt. Nedenfor ser du eksempler på endringer som kan påvirke omstillingsstønaden din.

Hvis du ikke har BankID eller ikke kan sende inn endringer digitalt,

Her kan du ettersende dokumentasjon i saken din.


#### Eksempler på endringer som kan ha betydning for stønaden din:
...
- du blir permittert
Sier du opp eller blir oppsagt, må du
...
- du endrer adresse eller kontonummer.
Sjekk hva du må

Hvis du får nytt kontonummer, kan du endre det på Min side. Hvis du ikke kan melde fra digitalt, kan du
...
- full uføretrygd
- overgangsstønad
Dersom uføretrygden du mottar fra Nav endrer seg, må du også melde fra til Nav.

Hvis du mener at opplysninger om inntektene dine er feil i beregningen for etteroppgjør, kan du melde fra og sende inn dokumentasjon.
...
Kan du ikke logge inn med BankId eller av andre grunner ikke kan melde fra om endringer digitalt, må du gi oss beskjed med posten.

Bor du i Norge kan du

Bor du i utlandet kan du sende dokumentasjon og endringer til

Hvert år sjekker Nav inntektsopplysningene i skatteoppgjøret ditt for å se om du har fått utbetalt riktig omstillingsstønad året før.

Inntekten din påvirker hvor mye omstillingsstønad du får utbetalt. Du får mindre utbetaling jo mer du tjener. Stønaden blir redusert med 45 prosent av den delen av inntekten din som er høyere enn halvparten av grunnbeløpet i folketrygden (G).

Hvis skatteoppgjøret viser at du har hatt en annen inntekt enn den inntekten vi brukte da vi beregnet stønaden din, vil Nav gjøre en ny beregning. Dette kalles etteroppgjør.

Hvis du har fått for lite utbetalt, kan du få en etterbetaling hvis du oppfyller de

Hvis du har fått for mye utbetalt, må du i de fleste tilfellene betale tilbake. Du slipper å betale tilbake til Nav hvis det du har fått for mye utbetalt er mindre enn ett rettsgebyr.

Det er rettsgebyret per 31. desember i etteroppgjørsåret som legges til grunn. Du finner en

Nav jobber med etteroppgjøret over en lengre periode fra vi får opplysninger om skatteoppgjøret fra Skatteetaten.

Du vil få brev om etteroppgjør hvis

- du ikke har fått riktig utbetaling av omstillingsstønaden i fjor
- du har fått riktig beregnet omstillingsstønad i fjor
Du får ikke brev fra oss hvis inntektsopplysningene er uendret, og du ikke har fått utbetaling av omstillingsstønad i fjor.

Hvis du har fått for lite utbetalt, mottar du et forhåndsvarsel med en ny beregning av omstillingsstønaden. Du må kontrollere at opplysningene i brevet stemmer og melde fra hvis noe er feil.

Hvis du ikke svarer, får du et vedtak basert på de opplysningene som står i forhåndsvarselet.

Hvis du melder fra om feil, vurderer vi opplysningene før du får et vedtak om etteroppgjøret. Vedtaket gir informasjon om utbetalingen, og det påløper ingen renter på etterbetalingen.

Du finner informasjon om skattetrekk på etterbetaling hos skatteetaten.no.

Hvis du har gjeld hos Skatteetaten, kan de kreve å få pengene fra etterbetalingen til å dekke gjelden.

Hvis du har fått for mye utbetalt, mottar du et forhåndsvarsel med en ny beregning av omstillingsstønaden. Du må kontrollere at opplysningene i forhåndsvarselet stemmer og melde fra hvis noe er feil.

Hvis du ikke svarer, får du et vedtak basert på de opplysningene som står i forhåndsvarselet. Melder du fra om feil, så vurderer vi opplysningene før du får et vedtak om etteroppgjøret. Vedtaket gir informasjon om hvordan du skal betale tilbake.

Det er avdelingen for Innkrevingsmyndigheten i Skatteetaten som er ansvarlig for å kreve tilbake penger på vegne av Nav.

Alle inntekter du har hatt i perioden med innvilget omstillingsstønad skal være med når vi gjør et etteroppgjør.

Ikke all pensjonsgivende inntekt fører til at omstillingsstønaden skal reduseres. Det gjelder inntekt du har tjent opp før du startet med omstillingsstønad.

Det kan for eksempel være:

- Inntekt fra arbeid eller utbetaling fra arbeid eller virksomhet som blir helt avsluttet før du fikk innvilget omstillingsstønad.
Feriepenger fra en jobb du sluttet i før du fikk omstillingsstønad.

Etterbetaling av lønnsoppgjør som gjelder perioden før du har fått omstillingsstønad.

Du må sende dokumentasjon på denne typen inntekter til Nav digitalt eller i posten. Det kan være lønnslipper, dokumentasjon fra en regnskapsfører eller lignende.

Du trenger ikke dokumentere inntekter fra Nav (eksempel arbeidsavklaringspenger, dagpenger). Du må likevel gi beskjed til oss hvis du har slike utbetalinger som gjelder fra før du ble innvilget omstillingsstønad. Når vi har mottatt nødvendig informasjon og dokumentasjon, vurderer vi saken din på nytt og du får et vedtak fra oss.

Hvis du mener at inntektsopplysningene i skatteoppgjøret er feil, må du kontakte Skatteetaten.

Hvis Skatteetaten endrer inntekten din, må du gi beskjed om dette til Nav slik at vi kan lage et nytt etteroppgjør. Du får tilbakemelding hvis endringen påvirker etteroppgjøret ditt.

Hvis pensjonsytelser fra andre pensjonsleverandører enn Nav blir endret, må du

Du kan svare på etteroppgjøret ved å sende inn opplysninger og dokumentasjon du mener kan ha betydning for etteroppgjøret ditt.

Hvis du ikke har BankID eller ikke kan svare på etteroppgjøret digitalt,
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/omstillingsstonad) av norges-lover-bot.*

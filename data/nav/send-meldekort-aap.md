<!-- innholds-hash: 0e9a3efccac6e70a00a6f97465741e19620a0d3243d26c987e7a92eb70e11b4b -->
...
- **Sist hentet:** 2026-07-21T03:19:44Z
...
Hvis du ønsker å være registrert som arbeidssøker, må du også bekrefte dette.
...
Når du er registrert som arbeidssøker samtidig som du mottar arbeidsavklaringspenger, må du bekrefte at du fortsatt ønsker å være registrert som arbeidssøker hver 14. dag. I tillegg må du sende inn meldekortet ditt.

Bekreftelse på at du ønsker å være registrert som arbeidssøker sender du inn digitalt.

Logg inn på Min Side for å se:

- når du må bekrefte at du vil være arbeidssøker
- hvilken periode bekreftelsen gjelder for
Les mer om
...
Hvis du ikke kan logge inn og sende meldekort digitalt, kan du skrive ut og sende
...
Du må sende meldekort hver 14. dag for å ha rett til
...
Hvis du blir fritatt fra plikten til selv å sende inn meldekort, har du fremdeles plikt til å

Når du skal fylle ut meldekortet, må du svare på 4 spørsmål. Her får du informasjon om hvordan du skal fylle ut meldekortet for hvert enkelt spørsmål.
...
- arbeid med etablering av egen virksomhet, hvis du har fått vedtak fra Nav om å
...
Husk at alt ulønnet arbeid må være avtalt med veilederen din og være en del av
...
Hvis du er usikker på om du skal føre timer for denne typen inntekter, kan du
...
Får du lønn for en fast stillingsprosent, skal du føre timer ut fra stillingsprosenten din. Vi regner full stilling som 37,5 timer per uke, uavhengig av hva som er normal arbeidstid i ditt yrke.

Hvis du jobber i en stilling som er mindre enn 100 prosent, må du regne om stillingen din til timer per uke. Får du ikke hele eller halve timer når du gjør dette, må du runde opp minuttene den ene uken, og runde ned den andre uken slik at du i meldeperioden totalt sett har ført timer som tilsvarer din stillingsprosent.

Hvis du for eksempel jobber 50 prosent, så utgjør det 18,75 timer per uke som skal føres slik: 18,5 timer på meldekortet den ene uken, og 19 timer på meldekortet den andre uken.

For å få riktig utbetaling, bør du fordele timene mest mulig jevnt utover virkedagene i meldeperioden, uavhengig av når du faktisk jobber. Årsaken er at hvis du får stans i arbeidsavklaringspengene (AAP) i løpet av meldeperioden, kan du risikere å gå over grensen for
...
Er du ansatt i en prosentstilling med fast lønn og jobber skift, skal du
...
Hvis du har fått vedtak fra Nav om at du kan beholde
...
Hvis du ikke vet hvor mange arbeidstimer sykepengene tilsvarer, kan du ta kontakt med arbeidsgiveren din eller
...
Hvis du er i tvil om hvordan du skal føre timer i din arbeidssituasjon, bør du
...
I noen tilfeller kan du jobbe mer enn hovedregelen på 60 prosent. Les mer om
...
Sjekk hvilke regler som gjelder utbetaling av AAP under
...
Det er egne regler for AAP ved opphold i utlandet. Før du reiser, må du sjekke hvilke regler som gjelder for landet du skal reise til, og undersøke om du må søke om godkjenning av Nav på forhånd:
...
Er du i tvil om du har forstått hvordan du skal fylle ut meldekortet, bør du
...
Hvis du ikke har mulighet til å rette feil i meldekortet digitalt, må du
...
Hvor mye du blir trukket, avhenger av hvor mange dager etter fristen du sender meldekortet. Sender du meldekortet én dag etter siste frist, får du trekk. Du blir trukket for antall dager fra første mandag etter at meldeperioden er over, til dagen du sendte inn meldekortet.

Hvis meldekortperioden er mandag 16. mars til søndag 29. mars, er første meldedag etter meldekortperioden mandag 30. mars.

Siste frist for å sende meldekortet uten trekk er mandag 6. april. Sender du meldekortet tirsdag 7. april får du trekk for 6 utbetalingsdager.
...
I noen tilfeller kan vi vurdere om du skal få
...
Hvis det har gått mer enn 3 virkedager siden du sendte inn meldekortet digitalt, og du fortsatt ikke har fått utbetalt penger, bør du

I oversikten over

Hvis meldekortet er sendt inn, men ikke er beregnet dagen etter at du sendte det, bør du
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/send-meldekort-aap) av norges-lover-bot.*

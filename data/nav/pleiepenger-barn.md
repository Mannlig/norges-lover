<!-- innholds-hash: 3c8154e2c11abd79a8db0b4aad990fabfc8aab682479ff1e9f161668aa476b54 -->
...
- **Sist hentet:** 2026-06-26T13:56:37Z
...
Det finnes også informasjon om pleiepenger for sykt barn til
...
#### Hva vil behovet for kontinuerlig tilsyn og pleie si?
...
Vi vurderer barnets pleiebehov når du søker om pleiepenger. Derfor er det viktig at legen beskriver barnets pleiebehov i legeerklæringen.

Det er kun leger i spesialisthelsetjenesten som kan skrive en slik legeerklæring. Det vil si at barnet må følges opp av spesialisthelsetjenesten, og at en lege er involvert i behandlingen/oppfølgingen.
...
Hvis du allerede har søkt om eller mottar pleiepenger, og nå skal søke foreldrepenger, legger du inn i søknaden hvilken periode barnet er innlagt. Da blir foreldrepengene utsatt for den perioden du får pleiepenger for.

Når søknaden er ferdig behandlet, får du et svar der det står hvordan perioden din med foreldrepenger blir.

Du trenger ikke si fra til oss at du skal søke om foreldrepenger når du har pleiepenger.

Hvis du har foreldrepenger, og barnet ditt blir innlagt på sykehus eller helseinstitusjon, kan du ha rett på pleiepenger. Du søker om pleiepenger på vanlig måte.

Foreldrepengene dine blir automatisk utsatt i samme periode som du mottar pleiepenger. Du behøver altså ikke gjøre noe med foreldrepengene dine i denne situasjonen.

Du kan også ha rett på pleiepenger hvis du har andre barn som blir innlagt på sykehus i løpet av perioden du har foreldrepenger.

Du har ikke rett til pleiepenger etter at barnet er skrevet ut fra sykehuset hvis du allerede mottar foreldrepenger. Pleiepenger skal dekke tapt inntekt, men når du allerede mottar foreldrepenger, har du ikke tapt arbeidsinntekt.
...
Du må gi beskjed hvis den faste og regelmessige tiden i omsorgstilbudet endrer seg.

Når du jobber samtidig som du mottar pleiepenger, skal pleiepengene reduseres ut fra hvor mye arbeidstiden din er redusert i forhold til det du vanligvis jobber. Pleiepengene graderes da per uke i perioden du søker om pleiepenger. Du må være borte fra jobb minst 20 prosent per uke for å få pleiepenger.
...
Hvis du har fått et nytt arbeidsforhold etter at du startet med pleiepenger, reduseres pleiepengene ut fra hvor mye du tjener i den nye jobben.

Noen foreldre som får pleiepenger for syke barn, har også rett til å få omsorgsstønad fra kommunen.

Omsorgsstønaden gis til de som utfører omsorgsarbeid på vegne av kommunen, uten å være fast ansatt. Omsorgsstønaden utbetales og skattlegges som frilansinntekt, og kan derfor påvirke retten til pleiepenger.

Når Nav vurderer retten til pleiepenger, må vi vurdere om du har tapt arbeidstid og inntekt sett opp mot alle dine arbeidsforhold.

Hvis du har omsorgsstønad når du starter med pleiepenger, vil denne frilansinntekten medregnes både som en del av arbeidstiden din og som en del av inntekten som kan kompenseres. Fordi de fleste fortsetter å motta omsorgsstønad, får dette sjelden betydning for pleiepengene. Men i noen tilfeller kan det få betydning:

- når vi vurderer om du har redusert arbeidsevne med minst 20%, vurderer vi ut fra alle arbeidsforholdene dine. Det betyr at timene du får omsorgsstønad for, regnes som en del av din vanlige arbeidstid.
- Hvis du jobber som frilanser i tillegg til å få omsorgsstønad, vil vi vurdere hvor mye arbeidstiden som frilanser samlet sett er redusert.
Du må derfor oppgi hvor mange timer du har fått innvilget omsorgsstønad for i søknaden. Dette står vanligvis i vedtaksbrevet du har fått fra kommunen. Vi finner beløpet på omsorgsstønaden i offentlige registre, men du må gi oss beskjed hvis det nylig har vært en endring i beløpet.

Hvis du får innvilget omsorgsstønad mens du mottar pleiepenger, regnes dette som en ny inntektskilde. Pleiepengene kan da reduseres, fordi du ikke har like stort inntektstap sett opp mot inntekten du hadde når du startet med pleiepenger.
...
Du opplyser i søknaden om hva som gjør at du må være i beredskap eller tilgjengelig. Hvis behovet oppstår etter at du har søkt, kan du
...
Du opplyser i søknaden om hva som gjør at du må være våken. Hvis behovet oppstår etter at du har søkt, kan du
...
I noen tilfeller kan du også få
...
Det er egne regler for hvor lenge du kan få pleiepenger hvis du oppholder deg i land

Du har ikke rett til pleiepenger for de dagene du avvikler ferie. Utbetaling av pleiepenger opphører i ferieperioden og begynner igjen etter at ferien er avviklet. Feriepenger skal erstatte inntektstapet i perioden du har ferie. Hvis du avvikler ferie når du mottar pleiepenger, må du
...
- Du kan følge med på Dine pleiepenger om vi har fått inntektsmelding fra arbeidsgiver. Hvis inntektsmeldingen er sendt til Nav etter 11. februar 2026 kan du også se hva arbeidsgiver har opplyst om.
...
Saksbehandlingstiden er for tiden
...
Hvis du søker om pleiepenger for mer enn 14 dager, skal arbeidsgiver også registrere fraværet som lovfestet permisjon i A-ordningen. Du kan sjekke hva som er registrert på deg ved å logge inn på
...
Du finner mer informasjon om retten til permisjon på
...
Hvis en annen omsorgsperson skal overta pleien helt eller delvis for ett barn fordi du skal pleie et annet barn, må du søke pleiepenger for barnet du nå skal pleie. Den andre omsorgspersonen må søke pleiepenger for barnet den skal overta pleien av. Hvis dere skal dele på å pleie flere barn, kan dere søke om pleiepenger for samme periode.

Hvis du har flere syke barn som er i omsorgstilbud på forskjellige tidspunkter, må du søke pleiepenger for alle barna. Dette er viktig for at du ikke skal få mindre i pleiepenger.

Hvis du har pleiepenger nå, ble beløpet beregnet basert på lønnen du hadde ved første dag med pleiepenger. Hvis du har hatt lønnsøkning som arbeidstaker siden da, kan pleiepengene for et nytt barn bli beregnet basert på den nye lønnen.
...
#### Delvis jobb hos opprinnelig arbeidsgiver

Noen får graderte pleiepenger for arbeidsforhold de har fått beregnet pleiepenger for, og samtidig får de en ny inntekt. Da vil pleiepengene graderes mot inntekt hvis dette gir lavere gradering enn det man får mot arbeid.


#### Når flere omsorgspersoner skal ha pleiepenger

Hvis pleiepengene dine blir gradert mot ny inntekt, er det denne graderingen som styrer hvor mye som er tilgjengelig for en annen omsorgsperson. Det er derfor som hovedregel den prosenten du får oppgitt i vedtaket som avgjør hvor mye som er tilgjengelig for andre søkere.

Gradering mot inntekt kan i enkelte tilfeller medføre en pleiepengegrad som er lavere enn 20%. Reglene for samtidig bruk av pleiepenger tilsier at man må ha minst 20% pleiepenger. Hvis pleiepengegraden din er lavere enn 20% på grunn av ny inntekt, vil du derfor likevel regnes som å bruke 20% av tilgjengelig uttak. Det er da inntil 80% pleiepenger tilgjengelig for andre omsorgspersoner.


#### Ny inntekt er høyere enn den inntekten pleiepengene skal dekke

Hvis den nye inntekten din er høyere enn det du har rett til i pleiepenger, vil du ikke ha rett til å få utbetalt pleiepenger.
...
Hvis endringen gjelder utenfor denne tidsrammen må du melde fra. Det samme gjelder hvis du er selvstendig næringsdrivende eller har pleiepenger for flere barn.
...
Andre endringer, for eksempel i stillingsprosent, melder du oss her:

Hvis du har fått ny inntekt i tillegg til pleiepengene, melder du fra om forventet ny inntekt. Det kan for eksempel være at du skal prøve å jobbe for en ny arbeidsgiver, har startet egen næring eller har fått innvilget omsorgsstønad fra kommunen.

Hvis tiden som barnet oppholder seg i omsorgstilbudet endrer seg, må du melde fra om endringen. Dette gjelder kun dersom endringen er fast og regelmessig.

Du kan gjøre endringer i opptil 3 måneder tilbake i tid, og opptil 12 måneder frem i tid.

Hvis endringen gjelder utenfor denne tidsrammen, må du også melde fra. Det samme gjelder hvis du er selvstendig næringsdrivende eller har pleiepenger for flere barn.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/pleiepenger-barn) av norges-lover-bot.*

<!-- innholds-hash: b5a9be2b95a0f035b7eddfc0c79e2d7259e766171ad627a5f72d72885363044f -->
...
- **Sist hentet:** 2026-05-12T17:48:29Z
...
Det finnes unntak fra regelen om at du må oppholde deg i Norge for å få dagpenger. Dette kan for eksempel gjelde hvis du har jobbet i Norge og pendlet til hjemlandet ditt, eller du kommer tilbake til Norge etter å ha jobbet i et annet EØS-land. Sjekk hva som gjelder for situasjonen din under

Det finnes noen unntak fra regelen om at du må oppholde deg i Norge for å få dagpenger. Les mer om
...
Fiskere har en egen dagpengeordning som administreres av Garantikassen for fiskere. Les mer om hvordan du
...
Les mer om hva du skal gjøre, og hva du har rett til,
...
Hvis du har blitt arbeidsledig i Norge kan du søke om arbeidsledighetstrygd i hjemlandet ditt. Du bør kontakte trygdemyndighetene i det andre EØS-landet for å sjekke om du har rett til arbeidsledighetstrygd der.
...
Hvis hjemlandet ditt

Saksbehandlingstiden for PD U1 er for tiden
...
- hvorfor du sluttet
Hvis du ikke har dokumentasjonen over, kan arbeidsgiveren din fylle ut

Har du jobbet i Norge, men reist hjem til et annet EØS-land minst én gang per uke kan du ha rett til dagpenger i Norge hvis du blir permittert eller


#### Du blir permittert eller delvis arbeidsledig

Hvis du blir permittert eller
...
Hvis du mister jobben din i Norge og blir
...
For å få norske dagpenger må du være i Norge. Du må
...
- Sverige
- Åland
Når du reiser til et annet EØS-land for å søke jobb, kan du ha rett til å beholde dagpenger fra Norge i opptil 3 måneder. For at dette skal gjelde deg, må du ha vært helt arbeidsledig og registrert som arbeidssøker i minst 4 uker før avreise.

Du trenger ikke å være registrert som arbeidssøker i 4 uker før avreise hvis du er innkalt til jobbintervju, eller hvis du reiser sammen med ektefellen/samboeren din som har fått jobb i et annet EØS-land. Du må dokumentere at ektefellen/samboeren din har fått jobb eller at du skal på jobbintervju. For å ha rett til å ta med deg dagpengene må du være helt arbeidsledig på avreisedatoen
...
Mens du mottar dagpenger fra Norge, må du fortsette å følge
...
Hvis du skal søke jobb i et annet EØS-land, kan Nav hjelpe deg gjennom
...
Disse inntektene viser

Vi bruker disse inntektene for å beregne hvor mye du kan få i dagpenger:
...
- Inntekt du har som selvstendig næringsdrivende
- Arbeidsavklaringspenger
Forsørger du barn under 18 år, får du et barnetillegg på 38 kroner per barn, 5 dager i uken. Dette utgjør 190 kroner i uken per barn. Hvis du forsørger barnet har du rett til barnetillegg selv om barnet ikke bor hos deg.
...
Du må betale skatt av dagpengene du får fra Nav. Det er lurt å

Du får første utbetaling med dagpenger når du har fått svar på søknaden. Saksbehandlingstiden for dagpenger er for tiden
...
Du kan få dagpenger som permittert fra fiskeindustrien i inntil 52 uker innenfor en periode på 18 måneder. Vi stanser dagpengene dine når perioden på 52 uker er over.

Arbeidsgivere i fiskeindustrien har ikke plikt til å betale lønn når du har mottatt dagpenger som permittert i 52 uker innenfor siste 18 måneder. Det finnes unntak fra denne regelen. Ta kontakt med arbeidsgiveren din for å finne ut hva som gjelder for deg.
...
Har du ikke alle dokumentene Nav trenger akkurat nå? Send inn det du har, og ettersend resten av dokumentene
...
Fra du har registrert deg som arbeidssøker, og mens du venter på svar på søknaden, må du sende meldekort hver 14. dag.

Det er flere krav til hva du må gjøre etter du har søkt.
...
Husk å sende meldekort mens du venter på svar på søknaden din. Du kan

Det er ulike regler for hvordan du skal fylle ut meldekortet ditt. Les mer om
...
Blir du sykemeldt over 50 prosent har du ikke lenger rett på dagpenger, men du kan ha rett på
...
- sier nei til jobb
- sier nei til å delta i, eller slutter i et
...
Du gir oss beskjed ved å

Når du får deg jobb eller er tilbake i jobb må du

- hvilken dato du starter
- hvor mye du skal jobbe
Du må gi beskjed til Nav så fort du vet når du skal begynne i jobben, slik at du får riktig utbetaling i overgangen til jobb.
...
Hvis du blir oppsagt, må du både
...
Hvis du sier opp selv må du både
...
Hvis permitteringen din forlenges, må du

Hvis arbeidsgiveren din går konkurs, må du både
...
Hvis du skal ha permisjon fra arbeidsplassen din, må du

Hvis du får barn mens du får dagpenger må du
...
Hvis du får deg nytt kontonummer, må du endre kontonummeret ditt på
...
Hvor lenge du kan få dagpenger mens du etablerer egen bedrift avhenger av hvordan Nav vurderer søknaden og hvor lenge du allerede har mottatt dagpenger.
...
- Du må eie mer enn 50 prosent av virksomheten, alene eller sammen med andre som får dagpenger eller arbeidsavklaringspenger.
...
- Sende inn næringsfaglig vurdering. Denne skal du ikke fylle ut selv.
...
Mottar du ikke dagpenger nå? Husk at du også må

Når du etablerer egen bedrift samtidig som du får dagpenger, er det egne regler for hvordan du skal fylle ut meldekortet. Les mer om
...
Du kan kombinere dagpenger og utdanning selv om du får støtte fra Lånekassen. Dagpengene kan påvirke støtten du får fra Lånekassen. Sjekk


#### Når bør du søke?

Du bør søke før studiestart. Saksbehandlingstiden er for tiden

- Nav stanser dagpengene dine, og du starter på utdanningen eller opplæringen
- Du beholder dagpengene dine, men starter
...
#### Starter du på utdanningen

Vær oppmerksom på at hvis du begynner på en utdanning eller opplæring

Hvis du starter på utdanningen
...
For å ha rett til dagpenger, må du fortsatt
...
Du kan lese om egne regler som gjelder for
...
Hvis du skal på ferie eller ha annet fravær, må du huske å føre dette på meldekortet ditt. Du kan lese mer om
...
For å ha rett til ferietillegg i år, må du ha fått dagpenger i mer enn 8 uker for i fjor. Du kan ha fått etterbetalt dagpenger i fjor som egentlig skulle vært utbetalt året før eller tidligere. Perioden du fikk etterbetalt dagpenger for telles ikke med når vi vurderer om du har fått dagpenger i mer enn 8 uker.
...
Se video: Dagpenger og ferie

Varighet er 1 min

Dette regnes med i ferietillegget:

- dagpenger du fikk utbetalt i fjor
...
- lønnsgarantimidler
Hvis du har jobbet mens du har fått dagpenger, kan du ha rett til en ny periode med dagpenger. For å få vurdert om du kan få en ny periode må du

Hvis du vil vite om du har rett til andre pengestøtter, kan du ta kontakt med
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/dagpenger) av norges-lover-bot.*

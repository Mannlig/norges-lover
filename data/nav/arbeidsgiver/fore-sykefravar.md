...
Sykefraværsstatistikk omfatter alle ansatte med et aktivt arbeidsforhold.

Dette gjelder både faste og midlertidige ansatte. Vikarer og fravær i ferie skal også inkluderes i statistikken.
...
En virksomhet har i løpet av et kvartal 250 avtalte dagsverk (arbeidsdager). Antall sykefraværsdager for samme kvartal er 25. Dette gir et sykefravær på 10 prosent av avtalte dagsverk.

Neste kvartal er avtalte dagsverk 270, mens antall sykefraværsdager er 26. Sykefraværet er nå 9,6 prosent av avtalte dagsverk.

Når året er slutt, finner du sykefraværet for året ved å summere antall sykefraværsdager og avtalte dagsverk, og regner ut prosenten slik som nevnt ovenfor.

Du finner avtalte dagsverk ved å gange antall ansatte med antall driftsdager per kvartal og stillingsandel. Hvis noen arbeider deltid, skal du bare medregne dem med stillingsprosenten deres.
...
Hvis en ansatt er syk i ferien men ikke får utbetalt sykepenger, skal du ikke regne med fraværet i avtalte dagsverk, men registrere det som ferie.

Hvis en ansatt har gradert (delvis) sykefravær, må du bruke sykefraværsgraden for å beregne hvor mange sykefraværsdager vedkommende har. Gradert sykefravær kan registreres i en egen kolonne i sykefraværsskjemaet, men det er frivillig og opp til hver enkelt virksomhet.
...
Er den ansatte gradert sykmeldt, skal du kun regne vedkommende som fraværende lik prosentsatsen til det graderte sykefraværet.
...
Har en person både deltidsstilling og er gradert sykmeldt, ganger du disse prosentene for å få riktig antall sykefraværsdager. Deltidsstilling skal omregnes opp mot stillingsprosent før du fører fraværet i skjemaet.

Har vedkommende samme stillingsprosent som over, men samtidig 50 prosent gradert sykefravær, ganger du antall sykefraværsdager som ble beregnet over med 0,5. Dette gir riktig antall sykefraværsdager.

Hvis du kombinerer stillingsprosenten og det graderte fraværet fra eksemplene over, får du følgende antall sykefraværsdager:

10 driftsdager x 3/5 x 0,5 = 3 sykefraværsdager.

Fraværene registreres i en av de følgende kolonnene:

Her registrerer du fravær med varighet fra 1 til og med 3 kalenderdager. Det er forskjell på egenmeldt fravær og fravær som er legemeldt (sykefravær dokumentert av lege). Du fører antall tilfeller og antall sykefraværsdager i de aktuelle kolonnene.
...
Her fører du sykefravær på mer enn 8 uker.

Du kan ikke alltid forutse om et sykefravær vil vare i minst 8 uker ved kvartalets utløp. Da må fraværet registreres på et senere tidspunkt. Når et sykefravær varer over 8 uker, skal du føre tilfellet og antall sykefraværsdager både under kolonne "I alt" og "Mer enn 8 uker" (men bare én gang og i den perioden sykefraværet oppsto i).

Eksempler på hvordan sykefraværet føres:
...
Dette kan være permisjon/godkjent fravær med eller uten lønn. Du skal ikke registrere denne typen fravær som sykefraværsdager.

Fødselspermisjon regnes også som "annet fravær". Gravide har rett til permisjon i 3 uker før fødselen med fødselspenger fra Nav. Hvis den gravide er sykmeldt, vil de siste 3 ukene før fødselen bli ansett som fødselspermisjon. Fravær i de siste 3 ukene før fødselen skal derfor ikke føres som sykefravær, men som permisjonsfravær.

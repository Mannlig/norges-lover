...
The employer must submit an income report when an employee is claiming sickness benefit, parental benefit, pregnancy benefit, or financial support due to illness in the family.
...
The income report is sent digitally. This can be submitted at the earliest four weeks before the absence starts.

You will be notified to submit the income form on My page - employer (Min side – arbeidsgiver). You will be asked to log in.
...
Employers use this form to inform Nav of the employee’s income in connection with an application for training allowance.
...
The income report contains income information and other information that Nav must have in order to process applications for sickness benefit, parental benefit, pregnancy benefit, or financial support due to illness in the family.

If you do not send the income statement on time, the payment from Nav to the employee or employer may be delayed.
...
Each employment relationship has its own employment ID, which allows you to distinguish between the employment relationships.
...
If the absence is lower than 100 per cent, Nav takes this into account in the payment.
...
The employer must send an income statement for each period of absence for which Nav must pay sickness benefit. If the employee recovers and is back at work before becoming ill again, an income report must be sent for the new period of absence. When the employer fills out an income report for the new period of absence, it must be stated that this is a new income report.
...
#### Must an income statement be sent for each sick leave?

If the employee is sick for a continuous period, a new income report must not be submitted for each individual sick leave.


#### What if the employer does not pay full salary during the employment period?
...
Nav notifies employers via Altinn when we have received an application for sickness benefits from an employee and lack income report to process the application.

The notification goes to persons the employer has entered as notification recipients under Notification addresses for the business in Altinn. Only people who have access to submit an income report can read the notice itself (to whom this applies).


#### Error in sending notifications

The application for sickness benefit lasts less than 16 days:

Check whether the employee has self-reported in the application for sickness benefit in advance of the sick leave, so that the total absence lasts for more than 16 days. Then the

If the employee has declared himself healthy on the application for sickness benefit before the absence has lasted for 16 days, we notify as of now if the sick leave lasts for more than 16 days. We are working to correct this.


#### Notification of income report in an ongoing case

If there are overlapping sick notices, sick notices with travel allowance or interrupted sick notices ahead of the notification, we see that it may be notified on the wrong basis. We are working to correct this.
...
- you are seeking reimbursement for paid care days
- the employee applies for payment directly from Nav, because the employer has not paid wages when the employee used care day

#### Must a new income report be sent for each absence?

You can add up several periods of absence in an income report, but note that we can only pay in arrears up to three months back in time.

If the absence extends over two calendar years, you must send an income report per calendar year.
...
The employee has attendance allowance from 1 January to 1 December. There is then a period of time before the employee receives attendance allowance again from 14 December. The employee went up in salary in November, and you now want to send an amendment to the income statement to include the salary change. You must then send an income report with the first day of absence on 14 December, as there is a stay during the period, and thus a new first day of absence.

Employees can have different combinations of employment relationships or types of income in a single enterprise or work for several different enterprises. It is important to take this into account when submitting an income report for an employee.
...
Here you will find the most important rules for calculating sickness benefit. You will find more about the rules in Chapter 8 of the National Insurance Act.

To calculate sickness benefit  during the employer period, you must first determine the employee's monthly income. Then, the daily rate to be paid for days of sick leave during this period is calculated.

As a general rule, the monthly income is determined based on an average of the income reported to the a-ordningen (reporting scheme) in the three last calendar months before the sick leave started. This period is called the calculation period.

Kari Nordmann becomes ill on 7 January 2025. It is Kari's average monthly income for October, November and December 2024 that you must use when calculating Kari's monthly income.
...
- If the employee has been on 100 percent leave of absence or layoff for more than 14 days, only the income earned after the interruption should be used when calculating the monthly income.
Read more

The monthly income for hourly paid employees must be converted into sick pay basis per day. The income must be distributed on the actual number of working days people have had during the calculation period. Sick pay is only given for days for which wages should have been paid.
...
In the income statement, you state the
...
Here you will find the most important rules for calculating parental benefit and pregnancy benefit. You will find more about the rules in Chapter 8 of the National Insurance Act.

- The employer must calculate the employee's monthly income.
- As a general rule, the monthly income must be determined based on an average of the income reported to the a-ordningen in the last 3 calendar months before the first day of absence.
- The employer must provide the same monthly income, regardless of whether the applicant has chosen 100 or 80 percent coverage
The main rule also applies to employees with changing working periods or incomes.

Kari Nordmann will receive parental allowance from 7 January 2021 (first day of absence). It is Kari's average monthly income for October, November and December 2020 that you should use when calculating the parental benefit.
...
Supplement for inconvenient working hours and inconvenience supplement for special working conditions should still be included in the calculation. You should also include remuneration for work on May 1st and 17th, as well as movable public holidays that the employee earns as a supplement per hour worked.
...
In this case, you should use 16 October as the starting point for the father’s parental benefit. Use the income reports to
...
Use 1 December as the starting point for the father’s parental benefit. Use the income reports to

Read more about

Here you will find the most important rules for calculating attendance allowance, care benefit and training allowance and pregnancy benefit. You will find more about the rules in Chapter 8 of the National Insurance Act.
...
Read more about which income is included in the

When the employment contract is transferred from one enterprise to another, the income report is used to complete reimbursements and create new ones.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/arbeidsgiver/inntektsmelding/en) av norges-lover-bot.*

...
- Oppgjørsrapport (tidligere kalt K27)
...
For virksomheter som forskutterer for ulike ytelser, som for eksempel sykepenger, tilbyr Nav en oversikt over hva Nav refunderer virksomheten i form av en oppgjørsrapport (tidligere kalt K27). Denne vil bli gjort tilgjengelig både for manuell nedlasting og gjennom API.
...
- sykmelding
- sykepengesøknad
- oppgjøresrapport (tidligere kalt K27)
...
Altinn beskriver hvordan du kan gi en medarbeider fullmakt til tilgangspakker og enkelttjenester:


#### Egendefinerte roller i Altinn 2 må delegeres på nytt

Når Nav migrerer løsningene sine bort fra Altinn 2‑teknologien, skal ingen i utgangspunktet miste tilgangene sine. Det finnes likevel ett viktig unntak: virksomheter som har opprettet egendefinerte roller i Altinn 2 og delegert disse til medarbeidere.

Medarbeidere som har fått tilgang til Nav‑tjenester basert på slike egendefinerte roller, vil miste disse tilgangene når Nav flytter løsningene sine ut av Altinn 2. Disse tilgangene må derfor delegeres på nytt. Vi anbefaler å delegere enten nye tilgangspakker eller eksplisitt tilgang til de nye Altinn 3‑ressursene.

Høsten 2026 vil Nav fjerne all tilgangsstyring basert på de gamle Altinn 2‑rollene. Derfor anbefaler vi at virksomheter allerede nå sørger for å delegere nye tilgangspakker og/eller eksplisitt tilgang til Altinn 3‑ressursene for de medarbeiderne som fortsatt er avhengige av dette.


---
*Automatisk hentet fra [NAV](https://www.nav.no/arbeidsgiver/moderniserte-tjenester) av norges-lover-bot.*

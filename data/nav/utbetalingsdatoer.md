...
Her finner du utbetalingsdatoer gjennom året for alle pengestøtter fra Nav.

Du finner oversikt over

Utbetalingsdatoen er dagen Nav garanterer at pengene skal være på kontoen din. Nav overfører pengene til bankene noen dager før. Derfor kan det hende du får utbetalingen på konto før datoen som er oppgitt.

Du kan


#### Utbetaling i utlandet

Hvis du får utbetaling fra Nav til konto i utlandet, kan du forvente å få pengene på konto 1 til 2 dager etter utbetalingsdatoen til en norsk konto.


#### Har du ikke fått utbetalingen din?

Hvis du ikke har fått pengene til forventet tid, kan du

Sjekk gjerne at du har lagt inn riktig kontonummer. Slik unngår du forsinket utbetaling hvis kontonummeret er feil.

- Logg inn for å
Hvis en teknisk feil fører til at mange vil få forsinket utbetaling, informerer vi om det på nav.no.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/utbetalingsdatoer) av norges-lover-bot.*

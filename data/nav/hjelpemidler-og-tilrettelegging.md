<!-- innholds-hash: a15c112fed2992f45fd26e5f47595cc6485746446868a8ec5d3dada858acec85 -->

# Informasjon om hjelpemidler og tilrettelegging - nav.no

## Kildeinformasjon

- **Kilde:** NAV (Arbeids- og velferdsdirektoratet) – https://www.nav.no/hjelpemidler-og-tilrettelegging
- **Sist hentet:** 2026-06-03T03:14:10Z
...
Det er kommunen som har ansvaret for å søke om hjelpemidler i skole og barnehage. Avhengig av både kommune og hjelpemiddeltype, varierer det hvilke deler av kommunen som tar hovedansvaret, men ofte vil dette være ergoterapitjenesten. Skolen eller barnehagen skal involveres. Spesialpedagoger, PPT (pedagogisk-psykologisk tjeneste), kommunale hørselskontakter eller synskontakter, er eksempler på fagpersoner som kan involveres.
...
Hvis du skal flytte fra en bolig med fastmonterte hjelpemidler, er det viktig at du opplyser til eiendomsmegler eller ny beboer at hjelpemidler ikke følger med. Hvis boligen skal selges, kan eiendomsmegler ta forbehold om dette i salgsoppgaven, og opplyse eventuelle kjøpere om dette ved visning.

Når overtagelsesdato er avtalt, må du raskt ta kontakt med kommunen for å gi beskjed om hjelpemidler som skal demonteres. Kommunen gir videre beskjed til Nav hjelpemiddelsentral, som kan avtale tidspunkt for demontering. Nav hjelpemiddelsentral sørger for demontering av hjelpemiddelet. Nav tetter hull og flikker sår i veggen som er forårsaket av monteringen, men dekker ikke istandsetting av boligen utover dette.

Dette gjelder også hvis du overtar et dødsbo med fastmonterte hjelpemidler.
...
Hvis hjelpemiddelet ditt går i stykker mens du er på innenlandsreise, og du har behov for reparasjon før du reiser hjem, kan du ta kontakt med hjelpemiddelsentralen i det fylket du oppholder deg i. Ta kontakt med servicetjenesten på telefon 55 55 11 11

Du kan ta med hjelpemidler til utlandet på ferie og opphold kortere enn 12 måneder.

Ved behov for reparasjon av hjelpemidler i utlandet, må du kontakte Nav hjelpemiddelsentral som vurderer hvordan problemet best kan løses Som regel vil Nav hjelpemiddelsentral sende bestilling til leverandør på stedet.

Hvis du flytter til utlandet, er hovedregelen at hjelpemidlene skal leveres tilbake. Det er unntak for studenter i studieopphold og personer utsendt fra den norske stat.

Hvis du har spørsmål om å ta med hjelpemidler til utlandet, kan du ta kontakt med oss.
...
Sjekk hjelpemidlet for eventuell transportskade umiddelbart etter uthenting. Hvis hjelpemidlet er skadet, må du melde det omgående til flyselskapet. Da vil du få et referansenummer og kontaktinformasjon som du sender til din Nav hjelpemiddelsentral.

Hjelpemidler som blir stjålet i utlandet må meldes til det lokale politiet. Bekreftelse på at tyveriet er politianmeldt må legges ved som dokumentasjon ved henvendelse om utlevering av nytt hjelpemiddel. Hvis hjelpemiddelet blir mistet av transportør underveis på en reise, kan du rapportere dette til transportør. Denne rapporten må du legge ved som dokumentasjon, ved henvendelse om utlevering av nytt hjelpemiddel.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/hjelpemidler-og-tilrettelegging) av norges-lover-bot.*

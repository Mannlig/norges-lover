<!-- innholds-hash: 5b8399ce610e14ffc5bb8d87d2fca4fe492998f344173f213fbe034847afd315 -->
...
- **Sist hentet:** 2026-06-27T00:18:45Z
...
Du kan lese om hvem som kan få de ulike ordningene under.

Du må være i arbeid eller utdanning for å få tilskudd til bil gjennom denne ordningen.

Du kan få tilskudd til bil til og fra arbeid eller utdanning når du har en varig funksjonsnedsettelse som gjør at du har store vansker med å benytte offentlig transport alene eller med følge. Funksjonsnedsettelsen kan være både fysisk og psykisk.
...
Inntektsgivende arbeid, inklusiv arbeid som lærling.
...
Du kan ikke få tilskudd til bil til og fra arbeid og utdanning når:
...
Transportbehov som dekkes gjennom annet lovverk, som skyss til skole eller til behandling, blir ikke regnet med i transportbehovet. Turer som kan dekkes ved transporttjeneste, drosje eller ved hjelp av nær familie blir også trukket fra når vi vurderer om transportbehovet er stort nok til at vi kan gi lån til bil.
...
Dersom du har en eldre, privatfinansiert bil fra før og søker om tilskudd, kan du enten få tilskudd til ny bil
...
Det er ditt ansvar å velge en bil som passer for deg.

Du kan ta kontakt med oss dersom du har spørsmål om bilvalg og spesialutstyr.

Dersom du allerede har kjøpt bil som må tilpasses, kan du be om veiledning hos Nav bilsenter.
...
Du kjøper ikke bilen selv. Sammen med deg finner Nav bilsenter ut hvilken bil du kan få.

Finansieringsformen er at du får et rente- og avdragsfritt lån til bilen. Bilen registreres på deg.

Lånet gjøres opp når du leverer inn igjen bilen eller hvis du overtar bilen ved å betale verdien av den til Nav.
...
Nav kan dekke inntil fem sitteplasser i en bil der det ikke går utover behovet for tilpassing og tilrettelegging. Type rullestol, hjelpemidler og vektbegrensning kan være med å avgjøre hvor mange sitteplasser bilen kan ha.
...
Du kan søke om tilhenger og tilhengerfeste for å frakte nødvendige forflytningshjelpemidler, for eksempel elektrisk rullestol. I vurderingen ser vi blant annet på hvilke formål hjelpemiddelet er innvilget til. Du kan bare få tilhenger dersom behovet gjelder i dagligliv eller arbeidslivet. Vi tar ikke hensyn til ferie- og fritidsreiser eller enkeltstående reiser.
...
Spesialutstyr og tilpassing av bil er ikke et tilskudd eller pengelån som du får utbetalt. Behovsprøving basert på inntekt er derfor ikke aktuelt for denne ordningen.
...
Hvis du har førerkort fra før, vil du få opplæring i bruk av spesialutstyr av bilombyggeren. Du vil få dekket nødvendige tilvenningstimer i bruk av kjøreteknisk utstyr og eventuelle kostnader forbundet med at førerkortet blir kodet.
...
Hvis søknaden gjelder barn, kan skjemaet fylles ut av foreldre eller verge. Hvis det gjelder voksne må det fylles ut av fagansvarlig helsepersonell.
...
Dette er egne skjema som fagpersonen selv må hente opp på nav.no, fylle ut, skrive ut og gi til deg eller ettersende.

Dette gjelder følgende skjema:
...
I tillegg til å oppgi det transportbehovet du har i dag, kan du også oppgi transport du ønsker å få dekket dersom du får stønad til egen bil.
...
- Dersom du er mindreårig eller under vergemål, må statsforvalteren godkjenne gjeldsstiftelsen og pantsettelsen
...
Du må regne med faste utgifter til forsikring, service, reparasjon og drivstoff til bilen.
...
- Du må følge serviceplanen på bilen. I garantiperioden kan forhandler kreve at dette gjøres hos merkeverksted. Vær oppmerksom på at service på 4-hjulstrekk er mer kostbart.
...
Innmontert spesialutstyr fra Nav vedlikeholdes og repareres av Nav.

Ved skade, feil, mangler eller behov for reparasjon av spesialutstyret må du kontakte bilombygger.

Du kan få refusjon av reiseutgifter ved reparasjon av spesialutstyr.

Spesialutstyr, tilpasning eller ombygging av bilen din fra Nav koster deg i utgangspunktet ingen ting. Utstyret låner du av Nav, og må levere det tilbake når du ikke trenger det lenger.
...
Du kan fritt bytte bil i tilskuddsperioden. Husk at ny bil må være registrert i ditt navn dersom du bytter. Du må selv må betale for overflytting av eventuelt spesialutstyr. Det blir ingen endringer i tilskuddet hvis du bytter bil.

Dersom helsetilstanden din endrer seg slik at du har behov for en spesialtilpasset kassebil, kan du få lån til dette uavhengig av når du fikk forrige tilskudd. Du må da betale tilbake den delen av tilskuddet som ikke er avskrevet.
...
Hvis du får innmontert spesialutstyret i en trygdefinansiert bil, kan du få stønad til nytt spesialutstyr når du får innvilget stønad til ny bil.
...
Du må følge anbefalt intervall for service og gjennomføre normalt vedlikehold på bilen. Du må også sørge for at bilen er EU-godkjent. Hvis bilen ikke er EU-godkjent risikerer du at vi gjennomfører gjeldsoppgjør på stønaden.
...
Når bilstønaden opphører vil vi foreta et gjeldsoppgjør.
...
Du er pliktig til å informere oss dersom du slutter i arbeid eller utdanning. Vi vil da vurdere bilsaken din på nytt.

Hvis du blir arbeidssøker må vi i hver enkelt sak vurdere om det skal gjennomføres gjeldsoppgjør.

Hvis du går over til uføretrygd vil retten til tilskuddet opphøre, og du må betale tilbake den delen av tilskuddet som ikke er avskrevet.

Hvis du tidligere har fått tilskudd til bil til og fra arbeid og utdanning og i stedet får lån til en spesialtilpasset kassebil, må du betale tilbake den delen av tilskuddet som enda ikke er avskrevet.

Dersom du ønsker å gjennomføre gjeldsoppgjør før tilskuddsperioden er utløpt må du ta kontakt med oss.
...
Når du leverer tilbake bilen til Nav, enten fordi du bytter til en ny bil eller fordi du ikke lenger trenger bilen eller fyller vilkårene, opphører stønadsforholdet.

Det skal alltid gjennomføres gjeldsoppgjør når stønadsforholdet opphører. Gjeldsoppgjøret innebærer at lånet til spesialtilpasset kassebil gjøres opp. Dette skjer normalt ved at bilen leveres inn til Nav.

Dersom Nav ikke vil bruke bilen på nytt, kan du velge å kjøpe ut bilen til fastsatt pris. Ved gjeldsoppgjør blir bilen verdivurdert. Dersom verdivurderingen avdekker et verditap som skyldes manglende service, reparasjon eller vedlikehold, vurderer vi om du må dekke dette. Hvis stønadsmottakeren er død, vil ikke dødsboet bli holdt ansvarlig for et slikt verditapet.

Det skal alltid gjennomføres gjeldsoppgjør dersom stønadsmottaker dør.

Nav kan kreve gjeldsoppgjør ved mislighold av vilkårene. Du har plikt til å informere oss dersom du slutter i arbeid eller utdanning. Vi vil da vurdere bilsaken din på nytt.

Dersom du ønsker å gjennomføre gjeldsoppgjør før stønadsperioden er utløpt, må du ta kontakt med oss.

Du beholder spesialutstyr i bilen så lenge du har behov for det.

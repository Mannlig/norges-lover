<!-- innholds-hash: 7e7e275fad6720f43f9effad5cf2deb36642b66569f49972d39346aceb073b4a -->
...
- **Sist hentet:** 2026-07-31T14:07:02Z
...
Child support is a private matter and refers to money that one parent pays to the other. The money is intended to help support the child when the parents do not live together. Parents are legally obligated to contribute financially to their children, regardless of their living arrangements. This obligation is stated in Sections 66 and 67 of the Norwegian Children Act.

Agreeing on child support without involving Nav means that you come to an agreement between yourselves and create a private arrangement tailored to your situation. If you would like a suggestion for the support amount, you can use the child support calculator. If you need help drafting a written private agreement, we offer a template you can use.

- decide the support amount yourselves
- choose how the payment will be made
- ask Nav to have the Tax Administration collect the support. The collection is free of charge.
- change the amount and other terms of the agreement at any time, based on what suits your situation
If you apply to Nav to determine the amount of child support, you must:

- comply with a comprehensive set of regulations
- expect the case processing to take time
- both parties must pay a fee of NOK 1,345
- expect that both the processing time and the fee will be the same if you later apply to change the support amount
- document visitation arrangements, childcare expenses, and other information Nav needs to make a decision
- expect to share all case information with the other parent
...
Watch video: How to make a private agreement

Duration is 1,5 min

The child support calculator is a tool for parents who wish to create a private child support agreement for children under 18 – without involving Nav.
...
There are no formal requirements for how a private child support agreement should look, but it’s wise to include the following points:

- which child(ren) the agreement applies to
- the agreed monthly amount
- whether you will settle payments privately or have the Tax Administration collect the support
- the start and end dates of the agreement
- signatures from both parties
To make it easier to create a private agreement, Nav has created a template you can use. There are two different templates: one for children under 18 and one for children over 18 who are entitled to support.

This template can be used when you want to enter into a private child support agreement for a child under the age of 18.

This template can be used when you want to enter into a private child support agreement for a benefit child over the age of 18.

Select the button “Notify of collection” if you already have a valid child support agreement and want the Tax Administration to collect the support.

If a child is born and the parents do not live together, Nav is required to determine child support. This means Nav will do it on your behalf if you have not informed Nav that you have a private agreement, or if you have not applied to Nav to set the support amount.

If you have made a private agreement, you must send it to Nav before we determine a child support. This way, you avoid paying the fee of NOK 1,345. The fee only applies if Nav has determined child support – not if we have only opened a case.
...
This form is for those who want to apply to calculate or adjust child support for children under 18 years old. You can also apply for advance support payment in this form.
...
Here is a list of the documentation that may be required in a child support case. You will be notified during the application process about what documentation is required in your case.

Here is a list of the documentation that may be required in a child support case. You will be notified during the application process about what documentation is required in your case.

This also applies if you pay child support for other children of your own who are not covered by this child support case.

You should use this form when you have received a notice in a case regarding child support.

The notice states that the other parent wants to calculate or adjust child support. You should fill out the form with your answers and information.

A child support case has multiple parties, who have the right to access shared information. This means that information you submit in the case will be forwarded by Nav to the other party, and vice versa.

Parents are usually obligated to support their children until the end of their upper secondary education. Child support ensures that the child is supported when the parents do not live together.
...
#### Apply for child support after turning 18

This form is for those who want to apply to calculate or adjust child support for benefit children over 18 years old.

A child support case has multiple parties, who have the right to access shared information. This means that information you submit in the case will be forwarded by Nav to the other party, and vice versa.

Here is a list of the documentation that may be required in a child support case after turning 18. You will be notified during the application process about what documentation is required in your case.

Here is a list of the documentation that may be required in a child support case after turning 18. You will be notified during the application process about what documentation is required in your case.

This also applies if you pay child support for other children of your own who are not covered by this child support case.

You should use this form when you have received a notice in a case regarding child support for benefit children over 18.

The notice states that the benefit child or a parent wants to calculate or adjust the child support. You should fill out the form with your answers and information.
...
You can use this form when there is something you want to let us know about your case.

Reminder that both parties have the right to access the joint case, and that the information you provide will be forwarded to the other party.
...
The decision has been made based on the information available at the time. If the information is incorrect, you may complain about the decision. If the information changes after the date of the decision, you can
...
If you have questions about receipts or payments, you must contact the Norwegian Tax Administration on telephone 21 05 11 00.
...
The non-custodial parent may enter into
...
Both parents must pay a fee for Nav to perform this service for you. The fee is NO 1,345, which is equivalent to one court fee.
...
Watch video: How Nav calculates child support
...
When a child lives permanently with one parent, the other parent is the non-custodial parent and is required to pay child support. If the child has a visiting arrangement with the non-custodial parent for more than an average of two days per month, a reduction in the child support amount may be granted.

This is called a visiting arrangement deduction. The deduction only applies if:

- the visiting arrangement has been agreed upon, either in writing or orally, and
- the visiting arrangement is actually carried out.
If you apply for Nav to determine child support and the child has shared permanent residence, Nav generally assumes that the parents share both contact time and costs equally. Child support may still be required if one of you has a higher income than the other.

Parents must share the cost of supporting the child in proportion to their income. This means that the parent with the higher income must cover a larger share of the total cost of support.

With shared permanent residence, parents usually each pay 50 percent of the cost of support. If one parent earns more than the other, the parent with the higher income must pay a net contribution corresponding to the share that exceeds 50 percent. This is paid as child support to the other parent.

If one parent spends significantly less time with the child than the shared permanent residence agreement provides for, Nav does not base the assessment on that agreement.

Kari earns 60 percent of their combined income of NOK 1,000,000. She already covers 50 percent of the cost of support.
...
When the municipality covers the child’s expenses, the municipality may demand a
...
We use fixed rates when we assess someone’s ability to pay child support. This means that we are not able to take into account your specific debt level and other expenditures.
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/barnebidrag/en) av norges-lover-bot.*

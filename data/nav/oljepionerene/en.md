...
The decisions are final and cannot be appealed. An appeal can either submitted via a court of law, or to
...
If you have previously received compensation for the same disease or injury for which you are seeking compensation, this will be deducted when the compensation is calculated. In the calculation, previously paid amounts must be converted to today's NOK value. When we calculate today's NOK value, we use Statistics Norway's

The Oil Pioneers Commission's calculation of the amount of the payment is based on
...
---
*Automatisk hentet fra [NAV](https://www.nav.no/oljepionerene/en) av norges-lover-bot.*

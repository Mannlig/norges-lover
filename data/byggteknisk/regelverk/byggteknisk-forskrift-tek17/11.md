<!-- innholds-hash: 0497aecd5f7230bc2e1b4c28a4bfed6b073274fccce7de4ee5d0176fc384fde8 -->

# Innledning til kapittel 11 Sikkerhet ved brann

## Kildeinformasjon

- **Kilde:** Direktoratet for byggkvalitet (DiBK) – https://www.dibk.no/regelverk/byggteknisk-forskrift-tek17/11/
- **Sist oppdatert (kilde):** ukjent
- **Sist hentet:** 2026-05-17T18:52:39Z
...
For definisjoner av branntekniske termer viser vi til


#### Brannteknisk prosjektering

Kravene til dokumentasjon framgår av

Dersom byggverket prosjekteres i samsvar med preaksepterte ytelser, kalles dette gjerne
...
Det er nødvendig at ansvarlig prosjekterende skaffer informasjon om lokale forutsetninger og rammebetingelser fra kommunen, eventuelt i en forhåndskonferanse. Dette omfatter blant annet brannvesenets utstyr (kjøretøy og høyderedskaper) og slokkevannsforsyning, jf.
...
Dersom det gjøres fravik fra de preaksepterte ytelsene, må brannsikkerheten dokumenteres ved analyse,

For byggverk i brannklasse 4, det vil si byggverk hvor konsekvensen ved brann kan bli meget stor for liv og helse, miljøet eller samfunnet generelt, må brannsikkerheten alltid dokumenteres ved analyse, jf.
...
Der hvor forskriften krever automatisk slokkeanlegg, angir de preaksepterte ytelsene at anlegget må være et automatisk sprinkleranlegg som er prosjektert og utført i samsvar med
...
Krav til dokumentasjon som grunnlag for bruksfasen framgår av

Ved ferdigattest skal det foreligge dokumentasjon for byggverkets og byggeproduktenes egenskaper som grunnlag for forvaltning, drift og vedlikehold av byggverket, jf.
...
For dokumentasjon av egenskaper til produkter vises til
...
C-klasse (C0-C5) angir dokumentert holdbarhet ut fra antall åpne-lukke-sykluser, jf.
...
Røyktetthet for dører og luker angis med betegnelsen S
...
[Eurefic-klassene A til E gjelder for sandwichelementer og overflateprodukter. De er basert på prøving etter
...
For gulvbelegg benyttes klassene A1


#### Isolasjon på rør og kanaler

For isolasjon på rør og kanaler benyttes klassene A1

[Tidligere ble klassene PI, PII og PIII benyttet. Materialene ble da testet i henhold til

For kabler benyttes klassene A

Klasser for ulike bruksområder for kabler er angitt


#### Taktekning

Taktekning klassifiseres med hensyn til antennelighet og flammespredning med klassebetegnelsen B

Med kledning menes en byggevare som benyttes innvendig eller utvendig på en vegg eller på undersiden av en etasjeskiller. Kledningsklassen angir kledningens evne til å beskytte sin egen bakside og bakenforliggende materiale mot antennelse. Klassen K


---
*Automatisk hentet fra [DiBK](https://www.dibk.no/regelverk/byggteknisk-forskrift-tek17/11/) av norges-lover-bot.*

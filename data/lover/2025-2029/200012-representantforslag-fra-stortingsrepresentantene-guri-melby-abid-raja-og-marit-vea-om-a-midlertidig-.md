<!-- innholds-hash: b04897c37d871a1ef17f05142d7a9f274f07347114f611f1868bda4addf27faf -->
...
- **Sak-ID:** 200012
- **Type:** 2
- **Korttittel:** Representantforslag om å midlertidig suspendere den nye modellen for beregning av formuesverdi av bolig
- **Status:** 1
...
```json
{
  "respons_dato_tid": "/Date(1779066079325+0200)/",
  "versjon": "1.6",
  "behandlet_sesjon_id": "2025-2026",
  "dokumentgruppe": 4,
  "emne_liste": [
    {
      "respons_dato_tid": "/Date(1779066079388+0200)/",
      "versjon": "1.6",
      "er_hovedemne": false,
      "hovedemne_id": 184,
      "id": 38,
  ...
  "forslagstiller_liste": [
    ...
    {
      "respons_dato_tid": "/Date(1779066079372+0200)/",
      "versjon": "1.6",
      "doedsdato": null,
      "etternavn": "Vea",
      "foedselsdato": "/Date(499039200000+0200)/",
      "fornavn": "Marit",
      "id": "MARVEA",
      "kjoenn": 1,
      "fylke": {
  ...
  "henvisning": "Dokument 8:97 S (2025-2026), Innst. 188 S (2025-2026)",
  "id": 200012,
  ...
  "status": 1,
  "tittel": "Representantforslag fra stortingsrepresentantene Guri Melby, Abid Raja og Marit Vea om å midlertidig suspendere den nye modellen for beregning av formuesverdi av bolig",
  "type": 2
}
```

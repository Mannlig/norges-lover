<!-- innholds-hash: 9e4d8f7cc7e7ea1e42f5b81c9b65007aec68bf32dab371a59544b7f85583d639 -->

# Representantforslag fra stortingsrepresentantene Ida Lindtveit Røse, Jorunn Gleditsch Lossius og Joel Ystebø om trygghet for mødre i barselomsorgen
...
- **Sak-ID:** 200149
- **Type:** 2
- **Korttittel:** Representantforslag om trygghet for mødre i barselomsorgen
- **Status:** 1
- **Stortingsperiode:** 2025-2029
- **Behandlet:** 
- **Sist hentet:** 2026-07-21T22:04:30Z
- **Sak-URL:** https://www.stortinget.no/no/Saker-og-publikasjoner/Saker/Sak/?p=200149

## Rådata (JSON fra API)

```json
{
  "respons_dato_tid": "/Date(1784668195686+0200)/",
  "versjon": "1.6",
  "behandlet_sesjon_id": "2025-2026",
  "dokumentgruppe": 4,
  "emne_liste": [
    {
      "respons_dato_tid": "/Date(1784668195701+0200)/",
      "versjon": "1.6",
      "er_hovedemne": false,
      "hovedemne_id": 40,
      "id": 41,
  ...
  "forslagstiller_liste": [
    {
      ...
      "kjoenn": 1,
      "fylke": {
        "respons_dato_tid": "/Date(1784631619564+0200)/",
        "versjon": "1.6",
      ...
      "parti": {
        "respons_dato_tid": "/Date(1784588417371+0200)/",
        "versjon": "1.6",
        "id": "KrF",
  ...
  "henvisning": "Dokument 8:205 S (2025-2026), Innst. 429 S (2025-2026)",
  "id": 200149,
  "innstilling_id": 17508,
  "innstilling_kode": 1,
  "komite": {
    "respons_dato_tid": "/Date(1784668190264+0200)/",
    "versjon": "1.6",
    "id": "HELSEOMS",
    "navn": "Helse- og omsorgskomiteen"
  },
  "korttittel": "Representantforslag om trygghet for mødre i barselomsorgen",
  "sak_fremmet_id": 200149,
  "saksordfoerer_liste": [
    {
      "respons_dato_tid": "/Date(1784668195686+0200)/",
      "versjon": "1.6",
  ...
  "status": 1,
  "tittel": "Representantforslag fra stortingsrepresentantene Ida Lindtveit Røse, Jorunn Gleditsch Lossius og Joel Ystebø om trygghet for mødre i barselomsorgen",
  "type": 2
}
```
